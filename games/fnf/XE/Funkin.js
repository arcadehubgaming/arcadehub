						...
						if(_gthis.curSelected != spr.ID) {
							...
							flixel_effects_FlxFlicker.flicker(spr,1,0.06,false,false,function(flick) {
								...
								case "freeplay":
									...
									haxe_Log.trace("Freeplay Menu Selected",{ fileName : "source/MainMenuState.hx", lineNumber : 206, className : "MainMenuState", methodName : "update"});
									break;
								case "options":
									var nextState = new OptionsMenu();
									if(flixel_FlxG.game._state.switchTo(nextState)) {
								...
								case "story mode":
									...
									haxe_Log.trace("Story Menu Selected",{ fileName : "source/MainMenuState.hx", lineNumber : 202, className : "MainMenuState", methodName : "update"});
									break;
								}
							});
						}
...
ManifestResources.init = function(config) {
	...
	var library = lime_utils_AssetLibrary.fromManifest(manifest);
	lime_utils_Assets.registerLibrary("tutorial",library);
	...
	lime_utils_Assets.registerLibrary("week1",library);
