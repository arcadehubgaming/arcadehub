...
var DialogueBox = function(talkingRight,dialogueList) {
	...
	case "break-in":
		flixel_FlxG.sound.playMusic(Paths.getPath("music/" + "daddiTalki" + "." + "mp3","MUSIC",null),0);
		var _this = flixel_FlxG.sound.music;
		var Duration = 1;
		var From = 0;
		var To = 0.8;
	...
	} else if(PlayState.SONG.song.toLowerCase() == "break-in") {
		this.portraitLeft = new flixel_FlxSprite(-1500,10);
		this.portraitLeft.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "portraits/dadPortrait" + ".png","IMAGE","shared"),Paths.getPath("images/" + "portraits/dadPortrait" + ".xml","TEXT","shared")));
		this.portraitLeft.animation.addByPrefix("enter","Dad Portrait Enter instance 1",24,false);
	...
	if(PlayState.SONG.song.toLowerCase() == "senpai" || PlayState.SONG.song.toLowerCase() == "roses" || PlayState.SONG.song.toLowerCase() == "thorns") {
		...
		this.portraitRight.animation.addByPrefix("enter","Boyfriend Portrait Enter instance 1",24,false);
	...
	if(PlayState.SONG.song.toLowerCase() == "senpai" || PlayState.SONG.song.toLowerCase() == "roses" || PlayState.SONG.song.toLowerCase() == "thorns") {
		...
		this.add(this.portraitLeft);
		this.portraitLeft.set_visible(false);
	} else if(PlayState.SONG.song.toLowerCase() == "midnight") {
		this.portraitLeft = new flixel_FlxSprite(-1500,10);
		this.portraitLeft.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "portraits/skidPortrait" + ".png","IMAGE","shared"),Paths.getPath("images/" + "portraits/skidPortrait" + ".xml","TEXT","shared")));
		this.portraitLeft.animation.addByPrefix("enter","Skid Portrait Enter 10008",24,false);
		this.portraitLeft.setGraphicSize(this.portraitLeft.get_width() * PlayState.daPixelZoom * 0.175 | 0);
		this.portraitLeft.updateHitbox();
		this.portraitLeft.scrollFactor.set();
		this.add(this.portraitLeft);
	...
	if(PlayState.SONG.song.toLowerCase() == "senpai" || PlayState.SONG.song.toLowerCase() == "roses" || PlayState.SONG.song.toLowerCase() == "thorns") {
		...
		this.add(this.portraitLeft);
		this.portraitLeft.set_visible(false);
	} else if(PlayState.SONG.song.toLowerCase() == "tickets-please!") {
		this.portraitLeft = new flixel_FlxSprite(-1500,10);
		this.portraitLeft.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "portraits/pumpPortrait" + ".png","IMAGE","shared"),Paths.getPath("images/" + "portraits/pumpPortrait" + ".xml","TEXT","shared")));
		this.portraitLeft.animation.addByPrefix("enter","Pump Portrait Enter instance 10008",24,false);
		this.portraitLeft.setGraphicSize(this.portraitLeft.get_width() * PlayState.daPixelZoom * 0.175 | 0);
		this.portraitLeft.updateHitbox();
		this.portraitLeft.scrollFactor.set();
		this.add(this.portraitLeft);
	...
	,update: function(elapsed) {
		...
		if(flixel_FlxG.keys.justPressed.get_ANY() && this.dialogueStarted == true) {
			...
			if(this.dialogueList[1] == null && this.dialogueList[0] != null) {
				if(!this.isEnding) {
					this.isEnding = true;
					if(PlayState.SONG.song.toLowerCase() == "senpai" || PlayState.SONG.song.toLowerCase() == "thorns" || PlayState.SONG.song.toLowerCase() == "break-in" || PlayState.SONG.song.toLowerCase() == "midnight" || PlayState.SONG.song.toLowerCase() == "tickets-please!") {
						var _this = flixel_FlxG.sound.music;
						var Duration = 2.2;
						var To = 0;
						if(To == null) {
...
FreeplayState.prototype = $extend(MusicBeatState.prototype,{
	...
	,create: function() {
		...
		var isDebug = false;
		this.addWeek(["Break-in","Midnight"],1,["dad"]);
		this.addWeek(["Tickets-Please!"],2,["spooky"]);
