...
var Character = function(x,y,character,isPlayer) {
	...
	case "bf":
		...
		break;
	case "bf-car":
		var tex1 = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "bfCar" + ".png","IMAGE","shared"),Paths.getPath("images/" + "bfCar" + ".xml","TEXT","shared"));
		this.set_frames(tex1);
		this.animation.addByPrefix("idle","BF idle dance",24,false);
		this.animation.addByPrefix("singUP","BF NOTE UP0",24,false);
		this.animation.addByPrefix("singLEFT","BF NOTE LEFT0",24,false);
	...
	case "bf-christmas":
		...
		break;
	case "bf-fuckyou":
		var tex1 = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "BOYFRIENDFUCKYOUWHOISREADINGTHIS" + ".png","IMAGE","shared"),Paths.getPath("images/" + "BOYFRIENDFUCKYOUWHOISREADINGTHIS" + ".xml","TEXT","shared"));
		this.set_frames(tex1);
		this.animation.addByPrefix("idle","BF idle dance",24,false);
		this.animation.addByPrefix("singUP","BF NOTE UP0",24,false);
		this.animation.addByPrefix("singLEFT","BF NOTE LEFT0",24,false);
		...
		break;
	case "bf-g":
		var tex1 = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "BOYFRIENDGLITCHER" + ".png","IMAGE","shared"),Paths.getPath("images/" + "BOYFRIENDGLITCHER" + ".xml","TEXT","shared"));
		this.set_frames(tex1);
		this.animation.addByPrefix("idle","BF idle dance",24,false);
		this.animation.addByPrefix("singUP","BF NOTE UP0",24,false);
		this.animation.addByPrefix("singLEFT","BF NOTE LEFT0",24,false);
		...
		break;
	case "bf-n":
		var tex1 = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "BOYFRIENDNIGHT" + ".png","IMAGE","shared"),Paths.getPath("images/" + "BOYFRIENDNIGHT" + ".xml","TEXT","shared"));
		this.set_frames(tex1);
		this.animation.addByPrefix("idle","BF idle dance",24,false);
		this.animation.addByPrefix("singUP","BF NOTE UP0",24,false);
		this.animation.addByPrefix("singLEFT","BF NOTE LEFT0",24,false);
	...
	case "bf-pixel-dead":
		...
		break;
	case "boyfriendwire":
		var tex1 = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "bfWIRE" + ".png","IMAGE","shared"),Paths.getPath("images/" + "bfWIRE" + ".xml","TEXT","shared"));
		this.set_frames(tex1);
		this.animation.addByPrefix("idle","BF idle dance",24,false);
		this.animation.addByPrefix("singUP","BF NOTE UP0",24,false);
		this.animation.addByPrefix("singLEFT","BF NOTE LEFT0",24,false);
	...
	case "gf":
		...
		break;
	case "gf-car":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "GF_assets_night" + ".png","IMAGE","shared"),Paths.getPath("images/" + "GF_assets_night" + ".xml","TEXT","shared"));
		this.set_frames(tex);
		this.animation.addByPrefix("cheer","GF Cheer",24,false);
		this.animation.addByPrefix("singLEFT","GF left note",24,false);
		this.animation.addByPrefix("singRIGHT","GF Right Note",24,false);
	...
	case "gf-christmas":
		...
		break;
	case "gf-g":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "GF_assets_glitcher" + ".png","IMAGE","shared"),Paths.getPath("images/" + "GF_assets_glitcher" + ".xml","TEXT","shared"));
		this.set_frames(tex);
		this.animation.addByPrefix("cheer","GF Cheer",24,false);
		this.animation.addByPrefix("singLEFT","GF left note",24,false);
		this.animation.addByPrefix("singRIGHT","GF Right Note",24,false);
		...
		break;
	case "gf-pixel":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "gfPixel" + ".png","IMAGE","shared"),Paths.getPath("images/" + "gfPixel" + ".xml","TEXT","shared"));
		this.set_frames(tex);
		this.animation.addByPrefix("cheer","GF Cheer",24,false);
		this.animation.addByPrefix("singLEFT","GF left note",24,false);
		this.animation.addByPrefix("singRIGHT","GF Right Note",24,false);
		...
		break;
	case "hexVirus":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "Hex_Virus" + ".png","IMAGE","shared"),Paths.getPath("images/" + "Hex_Virus" + ".xml","TEXT","shared"));
		this.set_frames(tex);
		this.animation.addByPrefix("idle","Hex crazy idle",24);
		this.animation.addByPrefix("singUP","Hex crazy up",24);
		this.animation.addByPrefix("singRIGHT","Hex crazy right",24);
		this.animation.addByPrefix("singDOWN","Hex crazy down",24);
		this.animation.addByPrefix("singLEFT","Hex crazy left",24);
		this.addOffset("idle");
		...
		break;
	case "hexWIRE":
		this.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "hexWIRE" + ".png","IMAGE","shared"),Paths.getPath("images/" + "hexWIRE" + ".xml","TEXT","shared")));
		this.animation.addByPrefix("idle","Hex crazy idle",24,false);
		this.animation.addByPrefix("singUP","Hex crazy up",24,false);
		this.animation.addByPrefix("singDOWN","Hex crazy down",24,false);
		this.animation.addByPrefix("singLEFT","Hex crazy left",24,false);
		this.animation.addByPrefix("singRIGHT","Hex crazy right",24,false);
		this.animation.addByPrefix("singUP-alt","Hex crazy up",24,false);
		this.animation.addByPrefix("singDOWN-alt","Hex crazy down",24,false);
		this.animation.addByPrefix("singLEFT-alt","Hex crazy left",24,false);
		this.animation.addByPrefix("singRIGHT-alt","Hex crazy right",24,false);
		this.addOffset("idle");
		this.addOffset("singUP",0,0);
		this.addOffset("singRIGHT",0,0);
		this.addOffset("singLEFT",0,0);
		...
		break;
	case "hexn":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "DADDY_DEAREST3" + ".png","IMAGE","shared"),Paths.getPath("images/" + "DADDY_DEAREST3" + ".xml","TEXT","shared"));
		this.set_frames(tex);
		this.animation.addByPrefix("idle","Dad idle dance",24);
		this.animation.addByPrefix("singUP","Dad Sing Note UP",24);
		this.animation.addByPrefix("singRIGHT","Dad Sing Note RIGHT",24);
		...
		break;
	case "hexs":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "DADDY_DEAREST2" + ".png","IMAGE","shared"),Paths.getPath("images/" + "DADDY_DEAREST2" + ".xml","TEXT","shared"));
		this.set_frames(tex);
		this.animation.addByPrefix("idle","Dad idle dance",24);
		this.animation.addByPrefix("singUP","Dad Sing Note UP",24);
		this.animation.addByPrefix("singRIGHT","Dad Sing Note RIGHT",24);
...
FreeplayState.prototype = $extend(MusicBeatState.prototype,{
	...
	,create: function() {
		...
		var isDebug = false;
		this.addWeek(["Dunk","RAM","hello-world"],1,["dad"]);
		this.addWeek(["glitcher"],1,["hexVirus"]);
		this.addWeek(["encore"],1,["dad"]);
...
var HealthIcon = function(char,isPlayer) {
	...
	this.animation.add("bf-fuckyou",[0,1],0,false,isPlayer);
	this.animation.add("bf-n",[0,1],0,false,isPlayer);
	this.animation.add("bfWIRE",[0,1],0,false,isPlayer);
	this.animation.add("bf-g",[0,1],0,false,isPlayer);
	...
	this.animation.add("dad",[24,25],0,false,isPlayer);
	this.animation.add("hexs",[24,25],0,false,isPlayer);
	this.animation.add("hexn",[24,25],0,false,isPlayer);
	...
	this.animation.add("hexVirus",[26,27],0,false,isPlayer);
	this.animation.add("hexWIRE",[26,27],0,false,isPlayer);
...
MainMenuState.prototype = $extend(MusicBeatState.prototype,{
	...
	,create: function() {
		...
		var versionShit = new flixel_text_FlxText(5,flixel_FlxG.height - 18,0,MainMenuState.gameVer + "- FNF - " + MainMenuState.kadeEngineVer + "SG - ",12);
...
ManifestResources.init = function(config) {
	...
	lime_utils_Assets.libraryPaths.h["tut