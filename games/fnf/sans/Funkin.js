...
var Character = function(x,y,character,isPlayer) {
	...
	case "pico":
		...
		break;
	case "sans":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "Sans_assets" + ".png","IMAGE","shared"),Paths.getPath("images/" + "Sans_assets" + ".xml","TEXT","shared"));
		this.set_frames(tex);
		this.animation.addByPrefix("idle","sans Idle Dance",24);
		this.animation.addByPrefix("singUP","sans Up note",24,false);
		this.animation.addByPrefix("singDOWN","sans Down Note",24,false);
		if(isPlayer) {
			this.animation.addByPrefix("singLEFT","sans Left Note",24,false);
			this.animation.addByPrefix("singRIGHT","sans Right Note",24,false);
		} else {
			this.animation.addByPrefix("singLEFT","sans Right Note",24,false);
			this.animation.addByPrefix("singRIGHT","sans Left Note",24,false);
		}
		this.addOffset("idle");
		this.addOffset("singUP",0,35);
		this.addOffset("singRIGHT",30,0);
		this.addOffset("singLEFT",0,0);
		this.addOffset("singDOWN",20,0);
		this.playAnim("idle");
		this.set_flipX(true);
		break;
	case "sans2":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "Sans_assets2" + ".png","IMAGE","shared"),Paths.getPath("images/" + "Sans_assets2" + ".xml","TEXT","shared"));
		this.set_frames(tex);
		this.animation.addByPrefix("idle","sans Idle Dance",24);
		this.animation.addByPrefix("singUP","sans Up note",24,false);
		this.animation.addByPrefix("singDOWN","sans Down Note",24,false);
		...
		break;
	case "sans3":
		this.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "Sans_assets3" + ".png","IMAGE","shared"),Paths.getPath("images/" + "Sans_assets3" + ".xml","TEXT","shared")));
		this.animation.addByPrefix("idle","sans Idle Dance",24,false);
		this.animation.addByPrefix("singUP","sans Up note",24,false);
		this.animation.addByPrefix("singDOWN","sans Down Note",24,false);
		this.animation.addByPrefix("singLEFT","sans Left Note",24,false);
		this.animation.addByPrefix("singRIGHT","sans Right Note",24,false);
		this.animation.addByPrefix("singUP-alt","sans Up note 4",24,false);
		this.animation.addByPrefix("singDOWN-alt","sans Down Note 4",24,false);
		this.animation.addByPrefix("singLEFT-alt","sans Left Note 4",24,false);
		this.animation.addByPrefix("singRIGHT-alt","sans Right Note 4",24,false);
		this.animation.addByPrefix("idle-alt","sans Idle Dance 4",24,false);
		this.addOffset("idle");
		this.addOffset("singUP",0,35);
		this.addOffset("singRIGHT",30,0);
		this.addOffset("singLEFT",0,0);
		this.addOffset("singDOWN",20,0);
		this.addOffset("singUP-alt",0,35);
		this.addOffset("singRIGHT-alt",30,0);
		this.addOffset("singLEFT-alt",0,0);
		this.addOffset("singDOWN-alt",20,0);
		this.playAnim("idle");
		this.set_flipX(true);
		break;
	case "senpai":
...
var DialogueBox = function(talkingRight,dialogueList) {
	...
	case "megalomaniac":
		hasDialog = true;
		this.box.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "Text_Boxes" + ".png","IMAGE","shared"),Paths.getPath("images/" + "Text_Boxes" + ".xml","TEXT","shared")));
		this.box.animation.addByPrefix("normalOpen","Sans Textbox",24,false);
		this.box.animation.addByIndices("normal","Sans Textbox",[4],"",24);
		break;
	case "reality-check":
		hasDialog = true;
		this.box.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "Text_Boxes" + ".png","IMAGE","shared"),Paths.getPath("images/" + "Text_Boxes" + ".xml","TEXT","shared")));
	...
	if(PlayState.SONG.song.toLowerCase() == "senpai" || PlayState.SONG.song.toLowerCase() == "roses" || PlayState.SONG.song.toLowerCase() == "thorns") {
		...
		this.portraitLeft.setGraphicSize(this.portraitLeft.get_width() * PlayState.daPixelZoom * 0.6 | 0);
	...
	} else if(PlayState.SONG.song.toLowerCase() == "stronger") {
		this.portraitLeft = new flixel_FlxSprite(-1500,10);
		this.portraitLeft.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "sansPotrait" + ".png","IMAGE","shared"),Paths.getPath("images/" + "sansPotrait" + ".xml","TEXT","shared")));
		this.portraitLeft.animation.addByPrefix("enter","Sans Portrait Enter",24,false);
		this.portraitLeft.setGraphicSize(this.portraitLeft.get_width() * PlayState.daPixelZoom * 0.6 | 0);
		this.portraitLeft.updateHitbox();
		this.portraitLeft.scrollFactor.set();
		this.add(this.portraitLeft);
	...
	if(PlayState.SONG.song.toLowerCase() == "senpai" || PlayState.SONG.song.toLowerCase() == "roses" || PlayState.SONG.song.toLowerCase() == "thorns") {
		this.portraitRight = new flixel_FlxSprite(0,-100);
		var library = null;
		...
		this.portraitRight.setGraphicSize(this.portraitRight.get_width() * PlayState.daPixelZoom * 0.6 | 0);
		...
		this.portraitRight = new flixel_FlxSprite(700,70);
		this.portraitRight.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "bfPortrait" + ".png","IMAGE","shared"),Paths.getPath("images/" + "bfPortrait" + ".xml","TEXT","shared")));
		this.portraitRight.animation.addByPrefix("enter","Boyfriend portrait enter",24,false);
		this.portraitRight.setGraphicSize(this.portraitRight.get_width() * PlayState.daPixelZoom * 0.6 | 0);
		this.portraitRight.updateHitbox();
		this.portraitRight.scrollFactor.set();
	...
	if(PlayState.SONG.song.toLowerCase() == "senpai" || PlayState.SONG.song.toLowerCase() == "roses" || PlayState.SONG.song.toLowerCase() == "thorns") {
		...
		this.add(this.portraitLeft);
		this.portraitLeft.set_visible(false);
	} else if(PlayState.SONG.song.toLowerCase() == "megalomaniac") {
		this.portraitLeft = new flixel_FlxSprite(-1500,10);
		this.portraitLeft.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "sansPotraitsweat" + ".png","IMAGE","shared"),Paths.getPath("images/" + "sansPotraitsweat" + ".xml","TEXT","shared")));
		this.portraitLeft.animation.addByPrefix("enter","Sans Portrait Entersweat",24,false);
		this.portraitLeft.setGraphicSize(this.portraitLeft.get_width() * PlayState.daPixelZoom * 0.6 | 0);
		this.portraitLeft.updateHitbox();
		this.portraitLeft.scrollFactor.set();
		this.add(this.portraitLeft);
	...
	if(PlayState.SONG.song.toLowerCase() == "senpai" || PlayState.SONG.song.toLowerCase() == "roses" || PlayState.SONG.song.toLowerCase() == "thorns") {
		...
		this.add(this.portraitLeft);
		this.portraitLeft.set_visible(false);
	} else if(PlayState.SONG.song.toLowerCase() == "reality-check") {
		this.portraitLeft = new flixel_FlxSprite(-1500,10);
		this.portraitLeft.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "sansPotraitsweatinghard" + ".png","IMAGE","shared"),Paths.getPath("images/" + "sansPotraitsweatinghard" + ".xml","TEXT","shared")));
		this.portraitLeft.animation.addByPrefix("enter","Sans Portrait Entersweatinghard",24,false);
		this.portraitLeft.setGraphicSize(this.portraitLeft.get_width() * PlayState.daPixelZoom * 0.6 | 0);
		this.portraitLeft.updateHitbox();
		this.portraitLeft.scrollFactor.set();
		this.add(this.portraitLeft);
	...
	this.handSelect = new flixel_FlxSprite(flixel_FlxG.width * 0.9,flixel_FlxG.height * 0.9).loadGraphic(Paths.getPath("images/" + "hand_textbox" + ".png","IMAGE","shared"));
...
FreeplayState.prototype = $extend(MusicBeatState.prototype,{
	...
	,create: function() {
		...
		var isDebug = false;
		this.addWeek(["stronger"],1,["sans"]);
		this.addWeek(["megalomaniac"],1,["sans2"]);
		this.addWeek(["reality-check"],1,["sans3"]);
...
var HealthIcon = function(char,isPlayer) {
	...
	this.animation.add("sans",[24,25],0,false,isPlayer);
	this.animation.add("sans2",[26,27],0,false,isPlayer);
	this.animation.add("sans3",[28,29],0,false,isPlayer);
...
ManifestResources.init = function(config) {
	...
	var data = "{\"name\":null,\"assets\":\"aoy4:pathy43:assets%2Fdata%2Fblammed%2Fblammed-easy.jsony4:sizei39025y4:typey4:TEXTy2:idR1y7:preloadtgoR0y43:assets%2Fdata%2Fblammed%2Fblammed-hard.jsonR2i53646R3R4R5R7R6tgoR0y38:assets%2Fdata%2Fblammed%2Fblammed.jsonR2i44638R3R4R5R8R6tgoR0y43:assets%2Fdata%2Fbopeebo%2Fbopeebo-easy.jsonR2i6561R3R4R5R9R6tgoR0y43:assets%2Fdata%2Fbopeebo%2Fbopeebo-hard.jsonR2i6564R3R4R5R10R6tgoR0y38:assets%2Fdata%2Fbopeebo%2Fbopeebo.jsonR2i6561R3R4R5R11R6tgoR0y33:assets%2Fdata%2FcharacterList.txtR2i182R3R4R5R12R6tgoR0y39:assets%2Fdata%2Fcocoa%2Fcocoa-easy.jsonR2i27364R3R4R5R13R6tgoR0y39:assets%2Fdata%2Fcocoa%2Fcocoa-hard.jsonR2i22841R3R4R5R14R6tgoR0y34:assets%2Fdata%2Fcocoa%2Fcocoa.jsonR2i30208R3R4R5R15R6tgoR0y28:assets%2Fdata%2Fcontrols.txtR2i324R3R4R5R16R6tgoR0y47:assets%2Fdata%2Fdadbattle%2Fdadbattle-easy.jsonR2i28153R3R4R5R17R6tgoR0y47:assets%2Fdata%2Fdadbattle%2Fdadbattle-hard.jsonR2i34945R3R4R5R18R6tgoR0y42:assets%2Fdata%2Fdadbattle%2Fdadbattle.jsonR2i30225R3R4R5R19R6tgoR0y34:assets%2Fdata%2Fdata-goes-here.txtR2zR3R4R5R20R6tgoR0y41:assets%2Fdata%2Feggnog%2Feggnog-easy.jsonR2i32768R3R4R5R21R6tgoR0y41:assets%2Fdata%2Feggnog%2Feggnog-hard.jsonR2i141118R3R4R5R22R6tgoR0y36:assets%2Fdata%2Feggnog%2Feggnog.jsonR2i35674R3R4R5R23R6tgoR0y36:assets%2Fdata%2FfreeplaySonglist.txtR2i8R3R4R5R24R6tgoR0y39:assets%2Fdata%2Ffresh%2Ffresh-easy.jsonR2i17647R3R4R5R25R6tgoR0y39:assets%2Fdata%2Ffresh%2Ffresh-hard.jsonR2i19185R3R4R5R26R6tgoR0y34:assets%2Fdata%2Ffresh%2Ffresh.jsonR2i18849R3R4R5R27R6tgoR0y37:assets%2Fdata%2Fhigh%2Fhigh-easy.jsonR2i34032R3R4R5R28R6tgoR0y37:assets%2Fdata%2Fhigh%2Fhigh-hard.jsonR2i26047R3R4R5R29R6tgoR0y32:assets%2Fdata%2F