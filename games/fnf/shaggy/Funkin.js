...
ChartingState.prototype = $extend(MusicBeatState.prototype,{
	...
	,addSongUI: function() {
		...
		var m_check = new flixel_addons_ui_FlxUICheckBox(10,45,null,null,"6 keys",100);
		...
		m_check.callback = function() {
			...
			haxe_Log.trace("vos sos puto",{ fileName : "source/ChartingState.hx", lineNumber : 202, className : "ChartingState", methodName : "addSongUI"});
		};
	...
	,addSectionUI: function() {
		...
		var swapSection = new flixel_ui_FlxButton(10,170,"Swap section",function() {
			...
			while(_g < _g1) {
				...
				var half = 4 + _gthis._song.mania * 2;
	...
	,loadSong: function(daSong) {
		...
		tmp.playMusic("songs:assets/songs/" + daSong.toLowerCase() + "/Inst." + "mp3",0.6);
	...
	,update: function(elapsed) {
		...
		if(this.curBeat % 4 == 0 && this.curStep >= 16 * (this.curSection + 1)) {
			haxe_Log.trace(this.curStep,{ fileName : "source/ChartingState.hx", lineNumber : 523, className : "ChartingState", methodName : "update"});
			haxe_Log.trace(this._song.notes[this.curSection].lengthInSteps * (this.curSection + 1),{ fileName : "source/ChartingState.hx", lineNumber : 524, className : "ChartingState", methodName : "update"});
			haxe_Log.trace("DUMBSHIT",{ fileName : "source/ChartingState.hx", lineNumber : 525, className : "ChartingState", methodName : "update"});
				...
				this.curRenderedNotes.forEach(function(note) {
					if(flixel_FlxG.mouse.overlaps(note)) {
						...
						if(_this.keyManager.checkStatus(17,_this.status)) {
							...
							haxe_Log.trace("tryin to delete note...",{ fileName : "source/ChartingState.hx", lineNumber : 552, className : "ChartingState", methodName : "update"});
	...
	,changeSection: function(sec,updateMusic) {
		...
		haxe_Log.trace("changing section" + sec,{ fileName : "source/ChartingState.hx", lineNumber : 774, className : "ChartingState", methodName : "changeSection"});
	...
	,updateGrid: function() {
		...
		while(_g < sectionInfo.length) {
			...
			var daStrumTime = i[0];
			var daSus = i[2];
			var note = new Note(daStrumTime,daNoteInfo % (4 + this._song.mania * 2));
	...
	,selectNote: function(note) {
		...
		while(_g < _g1.length) {
			var i = _g1[_g];
			++_g;
			if(i.strumTime == note.strumTime && i.noteData % (4 + this._song.mania * 2) == note.noteData) {
	...
	,deleteNote: function(note) {
		...
		while(_g < _g1.length) {
			var i = _g1[_g];
			++_g;
			if(i[0] == note.strumTime && i[1] % (4 + this._song.mania * 2) == note.noteData) {
	...
	,addNote: function() {
		...
		haxe_Log.trace(noteStrum,{ fileName : "source/ChartingState.hx", lineNumber : 999, className : "ChartingState", methodName : "addNote"});
		haxe_Log.trace(this.curSection,{ fileName : "source/ChartingState.hx", lineNumber : 1000, className : "ChartingState", methodName : "addNote"});
		this.updateGrid();
		this.updateNoteUI();
		this.autosaveSong();
	}
	...
	,daSpacing: null
	,loadLevel: function() {
		haxe_Log.trace(this._song.notes,{ fileName : "source/ChartingState.hx", lineNumber : 1045, className : "ChartingState", methodName : "loadLevel"});
	}
	,getNotes: function() {
		var noteData = [];
		var _g = 0;
...
var Control = $hxEnums["Control"] = { __ename__ : "Control", __constructs__ : ["UP","LEFT","RIGHT","DOWN","RESET","ACCEPT","BACK","PAUSE","CHEAT","L1","U1","R1","L2","D1","R2"]
