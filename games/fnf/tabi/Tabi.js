...
Alphabet.prototype = $extend(flixel_group_FlxTypedSpriteGroup.prototype,{
	...
	,update: function(elapsed) {
		if(this.isMenuItem) {
			...
			if(this.noAnim) {
				var a = this.y;
				this.set_y(a + 0.5 * (scaledY * 120 + flixel_FlxG.height * 0.48 - a));
				this.set_x(this.targetY * 20 + 90);
			}
			if(this.noAnimAh) {
				this.set_y(scaledY * 120 + flixel_FlxG.height * 0.48);
				this.set_x(this.targetY * 20 + 90);
			}
		}
...
ApplicationMain.main = function() {
	lime_system_System.__registerEntryPoint("Tabi",ApplicationMain.create);
};
ApplicationMain.create = function(config) {
	var app = new openfl_display_Application();
	ManifestResources.init(config);
	app.meta.h["build"] = "31";
	app.meta.h["company"] = "Homskiy";
	app.meta.h["file"] = "Tabi";
	app.meta.h["name"] = "Friday Night Funkin' VS Tabi";
	app.meta.h["packageName"] = "com.homskiy.tabi";
	app.meta.h["version"] = "0.2.7.1";
	var attributes = { allowHighDPI : false, alwaysOnTop : false, borderless : false, element : null, frameRate : null, height : 720, hidden : false, maximized : false, minimized : false, parameters : { }, resizable : true, title : "Friday Night Funkin' VS Tabi", width : 1280, x : null, y : null};
...
var Character = function(x,y,character,isPlayer) {
	...
	case "bf-christmas":
		...
		break;
	case "bf-knife":
		this.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "BF_Knife_death" + ".png","IMAGE","shared"),Paths.getPath("images/" + "BF_Knife_death" + ".xml","TEXT","shared")));
		this.animation.addByPrefix("idle","BF dies",24,false);
		this.animation.addByPrefix("singUP","BF dies",24,false);
		this.animation.addByPrefix("firstDeath","BF dies",24,false);
		this.animation.addByPrefix("deathLoop","BF Dead Loop",24,true);
		this.animation.addByPrefix("deathConfirm","BF Dead confirm",24,false);
		this.addOffset("singUP",-29,27);
		this.addOffset("firstDeath",37,11);
		this.addOffset("deathLoop",37,5);
		this.addOffset("deathConfirm",37,11);
		this.addOffset("idle",37,11);
		this.playAnim("idle");
		this.set_flipX(true);
		break;
	case "bf-pixel":
	...
	case "bf-tabi":
		...
		break;
	case "bf-tabi-crazy":
		var tex1 = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "BF_post_exp" + ".png","IMAGE","shared"),Paths.getPath("images/" + "BF_post_exp" + ".xml","TEXT","shared"));
		this.set_frames(tex1);
		this.animation.addByPrefix("idle","BF idle dance",24,false);
		this.animation.addByPrefix("singUP","BF NOTE UP0",24,false);
		this.animation.addByPrefix("singLEFT","BF NOTE LEFT0",24,false);
	...
	case "gf-pixel":
		...
		break;
	case "gf-tabi":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "GF_TABI" + ".png","IMAGE","shared"),Paths.getPath("images/" + "GF_TABI" + ".xml","TEXT","shared"));
		this.set_frames(tex);
		this.animation.addByPrefix("cheer","GF Cheer",24,false);
		this.animation.addByPrefix("singLEFT","GF left note",24,false);
		this.animation.addByPrefix("singRIGHT","GF Right Note",24,false);
		...
		break;
	case "gf-tabi-crazy":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "PostExpGF_Assets" + ".png","IMAGE","shared"),Paths.getPath("images/" + "PostExpGF_Assets" + ".xml","TEXT","shared"));
		this.set_frames(tex);
		this.animation.addByIndices("danceLeft","GF LayedDownHurt ",[0,1,2,3,4,5,6,7],"",24,false);
		this.animation.addByIndices("danceRight","GF LayedDownHurt ",[8,9,10,11,12,13,14,15],"",24,false);
		this.addOffset("danceLeft",-300,-250);
		this.addOffset("danceRight",-300,-250);
		this.playAnim("danceRight");
		break;
	case "mom":
		var library = null;
	...
	case "spooky":
		...
		break;
	case "tabi":
		this.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "TABI" + ".png","IMAGE","shared"),Paths.getPath("images/" + "TABI" + ".xml","TEXT","shared")));
		...
		this.addOffset("idle");
		this.addOffset("singUP",44,50);
		this.addOffset("singRIGHT",-15,11);
		this.addOffset("singLEFT",104,-28);
		this.addOffset("singDOWN",-5,-108);
		this.playAnim("idle");
		break;
	case "tabi-crazy":
		this.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "MadTabi" + ".png","IMAGE","shared"),Paths.getPath("images/" + "MadTabi" + ".xml","TEXT","shared")));
		this.animation.addByPrefix("idle","MadTabiIdle",24,false);
		this.animation.addByPrefix("singUP","MadTabiUp",24,false);
		this.animation.addByPrefix("singDOWN","MadTabiDown",24,false);
		this.animation.addByPrefix("singLEFT","MadTabiLeft",24,false);
		this.animation.addByPrefix("singRIGHT","MadTabiRight",24,false);
		this.addOffset("idle");
		this.addOffset("singUP",59,156);
		this.addOffset("singRIGHT",-15,-19);
		this.addOffset("singLEFT",184,-5);
		this.addOffset("singDOWN",-5,-30);
		this.playAnim("idle");
		break;
	}
	this.dance();
...
Character.prototype = $extend(flixel_FlxSprite.prototype,{
	...
	,dance: function() {
		if(!this.debugMode) {
			switch(this.curCharacter) {
			case "gf":case "gf-car":case "gf-christmas":case "gf-pixel":case "gf-tabi":case "gf-tabi-crazy":
	...
	,setZoom: function(toChange) {
		if(toChange == null) {
			toChange = 1;
		}
		this.daZoom = toChange;
		this.scale.set(toChange,toChange);
	}
	,playAnim: function(AnimName,Force,Reversed,Frame) {
		...
		if(Object.prototype.hasOwnProperty.call(this.animOffsets.h,AnimName)) {
			this.offset.set(daOffset[0] * this.daZoom,daOffset[1] * this.daZoom);
		} else {
			this.offset.set(0,0);
		}
	...
	,addOff: function(ind) {
		...
		if(Object.prototype.hasOwnProperty.call(this.animOffsets.h,offsetShit)) {
			this.animOffsets.h[offsetShit] = [this.animOffsets.h[offsetShit][0],this.animOffsets.h[offsetShit][1] + 1];
		}
	}
	,subOff: function(ind) {
		var offsetShit = "idle";
	...
	,addOff2: function(ind) {
		...
		if(Object.prototype.hasOwnProperty.call(this.animOffsets.h,offsetShit)) {
			this.animOffsets.h[offsetShit] = [this.animOffsets.h[offsetShit][0] + 1,this.animOffsets.h[offsetShit][1]];
		}
	}
	,subOff2: function(ind) {
		var offsetShit = "idle";
		switch(ind) {
		case 0:
			offsetShit = "singLEFT";
	...
	,printOff: function() {
		haxe_Log.trace(JSON.stringify(this.animOffsets),{ fileName : "source/Character.hx", lineNumber : 878, className : "Character", methodName : "printOff"});
		return this.formatShit(this.animOffsets,["singLEFT","singDOWN","singUP","singRIGHT"]);
	}
	,formatShit: function(otherShit,daCrap) {
		var ourOffsets = [];
		var _g = 0;
		var _g1 = daCrap.length;
		while(_g < _g1) {
			var i = _g++;
			if(Object.prototype.hasOwnProperty.call(otherShit.h,daCrap[i])) {
				ourOffsets.push(otherShit.h[daCrap[i]]);
			} else {
...
MusicBeatState.prototype = $extend(flixel_addons_ui_FlxUIState.prototype,{
	get_chromaticAberration: function() {
		return ChromaHandler.chromaticAberration;
	}
	,setChrome: function(daChrome) {
	...
	,create: function() {
		if(this.transIn != null) {
			haxe_Log.trace("reg " + Std.string(this.transIn.region),{ fileName : "source/MusicBeatState.hx", lineNumber : 50, className : "MusicBeatState", methodName : "create"});
		}
	...
	,update: function(elapsed) {
		...
		if(_this.keyManager.checkStatus(48,_this.status)) {
	...
	,__properties__: $extend(flixel_addons_ui_FlxUIState.prototype.__properties__,{get_controls:"get_controls",get_chromaticAberration:"get_chromaticAberration"})
});
...
ChartingState.prototype = $extend(MusicBeatState.prototype,{
	...
	,update: function(elapsed) {
		...
		this.curRenderedNotes.forEach(function(note) {
			if(note.y > _gthis.strumLine.y) {
				note.set_alpha(0.5);
				note.set_color(11184810);
			} else {
				note.set_alpha(1);
				note.set_color(16777215);
			}
		});
				...
				this.curRenderedNotes.forEach(function(note) {
					if(flixel_FlxG.mouse.overlaps(note)) {
						...
						if(_this.keyManager.checkStatus(17,_this.status)) {
							...
							haxe_Log.trace("tryin to delete note...",{ fileName : "source/ChartingState.hx", lineNumber : 524, className : "ChartingState", methodName : "update"});
	...
	,changeSection: function(sec,updateMusic) {
		...
		haxe_Log.trace("changing section" + sec,{ fileName : "source/ChartingState.hx", lineNumber : 754, className : "ChartingState", methodName : "changeSection"});
	...
	,updateGrid: function() {
		...
		while(_g < sectionInfo.length) {
			...
			var daStrumTime = i[0];
			var daSus = i[2];
			var note = new Note(false,daStrumTime,daNoteInfo % 4);
	...
	,addAltNote: function() {
		...
		var noteSus = 0;
		this._song.notes[this.curSection].sectionNotes.push([noteStrum,noteData,noteSus,1]);
		...
		haxe_Log.trace(this.curSelectedNote,{ fileName : "source/ChartingState.hx", lineNumber : 973, className : "ChartingState", methodName : "addAltNote"});
		var _this = flixel_FlxG.keys.pressed;
		if(_this.keyManager.checkStatus(17,_this.status)) {
			this._song.notes[this.curSection].sectionNotes.push([noteStrum,(noteData + 4) % 8,noteSus]);
		}
		haxe_Log.trace(noteStrum,{ fileName : "source/ChartingState.hx", lineNumber : 980, className : "ChartingState", methodName : "addAltNote"});
		haxe_Log.trace(this.curSection,{ fileName : "source/ChartingState.hx", lineNumber : 981, className : "ChartingState", methodName : "addAltNote"});
		this.updateGrid();
		this.updateNoteUI();
		this.autosaveSong();
	}
	,addNote: function() {
		...
		haxe_Log.trace(noteStrum,{ fileName : "source/ChartingState.hx", lineNumber : 1004, className : "ChartingState", methodName : "addNote"});
		haxe_Log.trace(this.curSection,{ fileName : "source/ChartingState.hx", lineNumber : 1005, className : "ChartingState", methodName : "addNote"});
		this.updateGrid();
		this.updateNoteUI();
		this.autosaveSong();
	}
	...
	,daSpacing: null
	,loadLevel: function() {
		haxe_Log.trace(this._song.notes,{ fileName : "source/ChartingState.hx", lineNumber : 1050, className : "ChartingState", methodName : "loadLevel"});
	}
	,getNotes: function() {
		var noteData = [];
		var _g = 0;
...
var ChromaticAberration = function() {
	if(this.__glFragmentSource == null) {
...
$hxClasses["ChromaticAberration"] = ChromaticAberration;
ChromaticAberration.__name__ = "ChromaticAberration";
ChromaticAberration.__super__ = flixel_graphics_tile_FlxGraphicsShader;
ChromaticAberration.prototype = $extend(flixel_graphics_tile_FlxGraphicsShader.prototype,{
	rOffset: null
	,gOffset: null
	,bOffset: null
	,__class__: ChromaticAberration
});
...
var ChromaHandler = function() { };
$hxClasses["ChromaHandler"] = ChromaHandler;
ChromaHandler.__name__ = "ChromaHandler";
ChromaHandler.setChrome = function(chromeOffset) {
	if(Highscore.getPhoto()) {
		chromeOffset = 0.0;
	}
	ChromaHandler.chromaticAberration.shader.get_data().rOffset.value = [chromeOffset];
	ChromaHandler.chromaticAberration.shader.get_data().gOffset.value = [0.0];
	ChromaHandler.chromaticAberration.shader.get_data().bOffset.value = [chromeOffset * -1];
};
var ClassConductor = function() { };
$hxClasses["ClassConductor"] = ClassConductor;
ClassConductor.__name__ = "ClassConductor";
ClassConductor.set = function(urShit) {
	ClassConductor.myShit = urShit;
};
ClassConductor.get = function() {
	var crap = ClassConductor.myShit;
	ClassConductor.myShit = "";
	return crap;
};
...
CoolUtil.coolDialogue = function(path) {
	var _this_r = new RegExp("\r","g".split("u").join(""));
	var daList1 = StringTools.trim(lime_utils_Assets.getText(path).replace(_this_r,"")).split("---SECTION START---\n");
	var daList = [];
	var _g = 0;
	while(_g < daList1.length) {
		var fuckyoumate = daList1[_g];
		++_g;
		if(fuckyoumate.indexOf("\n---SECTION END---") != -1) {
			var _this_r = new RegExp("\r","g".split("u").join(""));
			var someshit = StringTools.trim(fuckyoumate.replace(_this_r,"")).split("\n---SECTION END---");
			if(someshit.length > 0) {
				daList.push(StringTools.trim(someshit[0]).split("\n"));
			}
		}
	}
	var listToUse = [];
...
$hxClasses["CurrentVersion"] = CurrentVersion;
CurrentVersion.__name__ = "CurrentVersion";
CurrentVersion.get = function() {
	var theVersion = "1.0.0";
	return theVersion;
};
var Cutscene1 = function(callBack) {
	...
	this.bg = new flixel_FlxSprite().loadGraphic(Paths.getPath("images/" + "cutscenes/2" + ".png","IMAGE",null));
	this.bg.set_antialiasing(true);
	this.bg.set_width(1280);
	this.bg.set_height(720);
	this.add(this.bg);
	this.thankYouSoMuchAPieceOfShit = new flixel_FlxSprite(103,214);
	var library = null;
	this.thankYouSoMuchAPieceOfShit.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "anims/Tabi_into" + ".png","IMAGE",library),Paths.getPath("images/" + "anims/Tabi_into" + ".xml","TEXT",library)));
	this.thankYouSoMuchAPieceOfShit.scale.set(0.6,0.6);
	this.thankYouSoMuchAPieceOfShit.updateHitbox();
	var realFps = 24;
	this.fps = realFps * 2;
	var fk = [];
	this.start = 0;
	...
	this.thankYouSoMuchAPieceOfShit.animation.addByIndices("cutscene","Tabi Intro",fk,"",realFps,false);
	this.add(this.thankYouSoMuchAPieceOfShit);
	this.bg.set_visible(false);
	this.thankYouSoMuchAPieceOfShit.set_visible(false);
};
$hxClasses["Cutscene1"] = Cutscene1;
Cutscene1.__name__ = "Cutscene1";
Cutscene1.__super__ = flixel_group_FlxTypedSpriteGroup;
Cutscene1.prototype = $extend(flixel_group_FlxTypedSpriteGroup.prototype,{
	bg: null
	,thankYouSoMuchAPieceOfShit: null
	,finishCallback: null
	,start: null
	,end: null
	,fps: null
	...
	,init: function() {
		...
		this.thankYouSoMuchAPieceOfShit.set_visible(true);
		this.thankYouSoMuchAPieceOfShit.animation.play("cutscene",true);
		this.startUpdate = true;
	}
	,update: function(elapsed) {
		flixel_group_FlxTypedSpriteGroup.prototype.update.call(this,elapsed);
		var tmp = ClassConductor.get();
		var c = js_Boot.getClass(this);
		if(tmp == c.__name__) {
			this.init();
		}
		if(this.startUpdate) {
			if(this.thankYouSoMuchAPieceOfShit.animation._curAnim != null) {
				if(this.thankYouSoMuchAPieceOfShit.animation._curAnim.name == "cutscene" && this.thankYouSoMuchAPieceOfShit.animation._curAnim.finished) {
...
var Cutscene2 = function(callBack) {
	this.updateShit2Yes = false;
	this.updateShit2 = false;
	this.updateShitYes = false;
	this.updateShit = false;
	this.startUpdate = false;
	var _gthis = this;
	flixel_group_FlxTypedSpriteGroup.call(this);
	this.finishCallback = callBack;
	this.tabi = new Character(100,100,"tabi-crazy");
	this.gf1 = new Character(400,130,"gf-tabi");
	this.gf1.scrollFactor.set(0.95,0.95);
	this.gf2 = new Character(400,130,"gf-tabi-crazy");
	var _g = this.tabi;
	_g.set_x(_g.x - 300);
	var _g = this.tabi;
	_g.set_y(_g.y + 50);
	this.bf1 = new Character(770,450,"bf-tabi",true);
	this.bf2 = new Character(770,450,"bf-tabi-crazy",true);
	this.bf1.setZoom(1.2);
	var _g = this.bf1;
	_g.set_x(_g.x + 300);
	this.gf1.setZoom(1.2);
	var _g = this.gf1;
	_g.set_y(_g.y - 110);
	var _g = this.gf1;
	_g.set_x(_g.x - 50);
	this.bf2.setZoom(1.2);
	var _g = this.bf2;
	_g.set_x(_g.x + 300);
	this.gf2.setZoom(1);
	var _g = this.gf2;
	_g.set_x(_g.x + 100);
	this.tabiLaugh = new flixel_FlxSprite(100,100);
	var _g = this.tabiLaugh;
	_g.set_x(_g.x - 450);
	var _g = this.tabiLaugh;
	_g.set_y(_g.y - 50);
	var library = null;
	this.tabiLaugh.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "anims/Tabi_Cutscene" + ".png","IMAGE",library),Paths.getPath("images/" + "anims/Tabi_Cutscene" + ".xml","TEXT",library)));
	this.tabiLaugh.animation.addByPrefix("animationshit","Tabi_Cutscene",0,false);
	this.tabiLaugh.animation.play("animationshit",true);
	this.genocideBG = new flixel_FlxSprite(-600,-300).loadGraphic(Paths.getPath("images/" + "wadsaaa" + ".png","IMAGE","shared"));
	this.genocideBG.set_antialiasing(true);
	this.genocideBG.scrollFactor.set(0.9,0.9);
	this.add(this.genocideBG);
	this.bgFire1 = new SiniFire(this.genocideBG.x + 720.,this.genocideBG.y + 180,true,false,30,0,84);
	this.bgFire1.set_antialiasing(true);
	this.bgFire1.scrollFactor.set(0.9,0.9);
	this.bgFire1.scale.set(0.4,1);
	var _g = this.bgFire1;
	_g.set_y(_g.y + 50);
	this.bgFire2 = new SiniFire(this.genocideBG.x + 1195.,this.genocideBG.y + 180,true,false,30,10,84);
	this.bgFire2.set_antialiasing(true);
	this.bgFire2.scrollFactor.set(0.9,0.9);
	this.bgFire2.scale.set(0.4,1);
	var _g = this.bgFire2;
	_g.set_y(_g.y + 50);
	this.add(this.bgFire1);
	this.add(this.bgFire2);
	this.genocideBoard = new flixel_FlxSprite(this.genocideBG.x,this.genocideBG.y).loadGraphic(Paths.getPath("images/" + "boards" + ".png","IMAGE","shared"));
	this.genocideBoard.set_antialiasing(true);
	this.genocideBoard.scrollFactor.set(0.9,0.9);
	this.add(this.genocideBoard);
	this.fire1 = new SiniFire(this.genocideBG.x + (-100),this.genocideBG.y + 889,true,false,30);
	this.fire1.set_antialiasing(true);
	this.fire1.scrollFactor.set(0.9,0.9);
	this.fire1.scale.set(2.5,1.5);
	var _g = this.fire1;
	_g.set_y(_g.y - this.fire1.get_height() * 1.5);
	this.fire1.set_flipX(true);
	this.fire2 = new SiniFire(this.fire1.x + this.fire1.get_width() - 80,this.genocideBG.y + 889,true,false,30);
	this.fire2.set_antialiasing(true);
	this.fire2.scrollFactor.set(0.9,0.9);
	var _g = this.fire2;
	_g.set_y(_g.y - this.fire2.get_height());
	this.fire3 = new SiniFire(this.fire2.x + this.fire2.get_width() - 30,this.genocideBG.y + 889,true,false,30);
	this.fire3.set_antialiasing(true);
	this.fire3.scrollFactor.set(0.9,0.9);
	var _g = this.fire3;
	_g.set_y(_g.y - this.fire3.get_height());
	this.fire4 = new SiniFire(this.fire3.x + this.fire3.get_width() - 10,this.genocideBG.y + 889,true,false,30);
	this.fire4.set_antialiasing(true);
	this.fire4.scrollFactor.set(0.9,0.9);
	this.fire4.scale.set(1.5,1.5);
	var _g = this.fire4;
	_g.set_y(_g.y - this.fire4.get_height() * 1.5);
	this.add(this.fire1);
	this.add(this.fire2);
	this.add(this.fire3);
	this.add(this.fire4);
	this.fuckYouFurniture = new flixel_FlxSprite(this.genocideBG.x,this.genocideBG.y).loadGraphic(Paths.getPath("images/" + "glowyfurniture" + ".png","IMAGE","shared"));
	this.fuckYouFurniture.set_antialiasing(true);
	this.fuckYouFurniture.scrollFactor.set(0.9,0.9);
	this.add(this.fuckYouFurniture);
	this.destBoombox = new flixel_FlxSprite(400,130).loadGraphic(Paths.getPath("images/" + "Destroyed_boombox" + ".png","IMAGE","shared"));
	var _g = this.destBoombox;
	_g.set_y(_g.y + (this.destBoombox.get_height() - 648) * -1);
	var _g = this.destBoombox;
	_g.set_y(_g.y + 150);
	var _g = this.destBoombox;
	_g.set_x(_g.x - 110);
	this.destBoombox.scale.set(1.2,1.2);
	this.add(this.destBoombox);
	this.add(this.gf2);
	this.add(this.tabi);
	this.add(this.bf2);
	this.sumsticks = new flixel_FlxSprite(-600,-300).loadGraphic(Paths.getPath("images/" + "overlayingsticks" + ".png","IMAGE","shared"));
	this.sumsticks.set_antialiasing(true);
	this.sumsticks.scrollFactor.set(0.9,0.9);
	this.sumsticks.set_active(false);
	this.add(this.sumsticks);
	this.bg = new flixel_FlxSprite(-600,-300).loadGraphic(Paths.getPath("images/" + "normal_stage" + ".png","IMAGE","shared"));
	this.bg.set_antialiasing(true);
	this.bg.scrollFactor.set(0.9,0.9);
	this.bg.set_active(false);
	this.add(this.bg);
	this.add(this.gf1);
	this.add(this.tabiLaugh);
	this.add(this.bf1);
	this.sumtable = new flixel_FlxSprite(-600,-300).loadGraphic(Paths.getPath("images/" + "sumtable" + ".png","IMAGE","shared"));
	this.sumtable.set_antialiasing(true);
	this.sumtable.scrollFactor.set(0.9,0.9);
	this.sumtable.set_active(false);
	this.add(this.sumtable);
	this.bgFire1.set_visible(false);
	this.bgFire2.set_visible(false);
	this.fire1.set_visible(false);
	this.fire2.set_visible(false);
	this.fire3.set_visible(false);
	this.fire4.set_visible(false);
	this.genocideBG.set_visible(false);
	this.genocideBoard.set_visible(false);
	this.gf2.set_visible(false);
	this.tabi.set_visible(false);
	this.bf2.set_visible(false);
	this.sumsticks.set_visible(false);
	this.bg.set_visible(false);
	this.gf1.set_visible(false);
	this.tabiLaugh.set_visible(false);
	this.bf1.set_visible(false);
	this.sumtable.set_visible(false);
	this.destBoombox.set_visible(false);
	this.fuckYouFurniture.set_visible(false);
	new flixel_util_FlxTimer().start(0.5,function(tmr) {
		_gthis.gf1.dance();
		_gthis.gf2.dance();
		_gthis.bf1.playAnim("idle",true);
		_gthis.bf2.playAnim("idle",true);
		_gthis.tabi.playAnim("idle",true);
	},0);
};
$hxClasses["Cutscene2"] = Cutscene2;
Cutscene2.__name__ = "Cutscene2";
Cutscene2.__super__ = flixel_group_FlxTypedSpriteGroup;
Cutscene2.prototype = $extend(flixel_group_FlxTypedSpriteGroup.prototype,{
	finishCallback: null
	,startUpdate: null
	,updateShit: null
	,updateShitYes: null
	...
	,sumtable: null
	,sumsticks: null
	,fuckYouFurniture: null
	,destBoombox: null
	,init: function() {
		this.startUpdate = true;
		this.bgFire1.set_visible(true);
		this.bgFire2.set_visible(true);
		this.fire1.set_visible(true);
		this.fire2.set_visible(true);
		this.fire3.set_visible(true);
		this.fire4.set_visible(true);
		this.genocideBG.set_visible(true);
		this.genocideBoard.set_visible(true);
		this.gf2.set_visible(true);
		this.tabi.set_visible(true);
		this.bf2.set_visible(true);
		this.sumsticks.set_visible(true);
		this.bg.set_visible(true);
		this.gf1.set_visible(true);
		this.tabiLaugh.set_visible(true);
		this.bf1.set_visible(true);
		this.sumtable.set_visible(true);
		this.destBoombox.set_visible(true);
		this.fuckYouFurniture.set_visible(true);
		this.updateShit = true;
		this.curSound = flixel_FlxG.sound.play(Paths.sound("voices/tabi3/tabilaugh"));
		this.get_camera().set_zoom(0.6);
	}
	,finishedCurSound: function() {
		var _gthis = this;
		this.updateShitYes = false;
		this.updateShit = false;
		this.bg.set_visible(false);
		...
		this.bf1.set_visible(false);
		this.sumtable.set_visible(false);
		this.curSound2 = flixel_FlxG.sound.play(Paths.sound("explode"));
		if(!Highscore.getPhoto()) {
			this.get_camera().fade(-1,5,true);
		}
		new flixel_util_FlxTimer().start(1,function(tmr) {
			var tmp = flixel_FlxG.sound;
			var tmp1 = Paths.sound("afterexplode");
			_gthis.curSound3 = tmp.play(tmp1);
			_gthis.updateShit2 = true;
		},1);
		ChromaHandler.setChrome(0.01);
		new flixel_util_FlxTimer().start(1,function(tmr) {
			ChromaHandler.setChrome(0.006);
			new flixel_util_FlxTimer().start(1,function(tmr) {
				ChromaHandler.setChrome(0.005);
				new flixel_util_FlxTimer().start(0.5,function(tmr) {
					ChromaHandler.setChrome(0.003);
				},1);
			},1);
		},1);
	}
	,finishedCurSound2: function() {
		haxe_Log.trace("yes done",{ fileName : "source/Cutscene2.hx", lineNumber : 297, className : "Cutscene2", methodName : "finishedCurSound2"});
		this.updateShit2Yes = false;
		this.updateShit2 = false;
		this.set_visible(false);
		this.startUpdate = false;
		this.get_camera().set_zoom(1);
	...
	,update: function(elapsed) {
		...
		if(this.startUpdate && this.updateShit && this.curSound != null) {
			this.tabiLaugh.animation._curAnim.set_curFrame((this.tabiLaugh.animation._curAnim.frames.length - 1) * (this.curSound._time / this.curSound._length) | 0);
			if(this.curSound._time / this.curSound._length != 0) {
				this.updateShitYes = true;
			}
			if(this.curSound._time / this.curSound._length <= 0 && this.updateShitYes) {
				this.finishedCurSound();
			}
		}
		if(this.startUpdate && this.updateShit2 && this.curSound3 != null) {
			if(this.curSound3._time / this.curSound3._length != 0) {
				this.updateShit2Yes = true;
			}
			if(this.curSound3._time / this.curSound3._length <= 0 && this.updateShit2Yes) {
				this.finishedCurSound2();
			}
		}
	}
	,__class__: Cutscene2
...
var DialogueBox = function(talkingRight,dialogueList) {
	...
	this.defaultSound = "pixelText";
	this.enableTypeSound = false;
	this.extraRights = [];
	this.extraCharnames = ["bf-left","bf-exp","bf-right","gf","gf-talking","gf-hmm","gf-letsgo","tabi","tabi-mad","tabi-worried"];
	this.blackListed = ["my-battle","last-chance","genocide"];
	this.queueFade = false;
	this.toFade = 0;
	...
	var _gthis = this;
	flixel_group_FlxTypedSpriteGroup.call(this);
	this.whitelisted = ["chromeoffset","soundoverwritestop","musicstop","music","musicloop","soundoverwrite","sound","class","class-use","bg","bghide","makeGraphic","enableTypeSound","disableTypeSound","switchSound","fadeIn","fadeOut"];
	...
	if(this.blackListed.indexOf(PlayState.SONG.song.toLowerCase()) != -1) {
		this.box = new flixel_FlxSprite(-20,flixel_FlxG.height - 45);
	} else {
		this.box = new flixel_FlxSprite(-20,45);
	}
	var hasDialog = false;
	switch(PlayState.SONG.song.toLowerCase()) {
	case "genocide":case "last-chance":case "my-battle":
		hasDialog = true;
		var library = null;
		this.box.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "speech_bubble_talking" + ".png","IMAGE",library),Paths.getPath("images/" + "speech_bubble_talking" + ".xml","TEXT",library)));
		this.box.animation.addByPrefix("normalOpen","Speech Bubble Normal Open",24,false);
		this.box.animation.addByPrefix("normal","speech bubble normal",24,true);
		break;
	case "roses":
		hasDialog = true;
	...
	this.daBg = new flixel_FlxSprite().makeGraphic(flixel_FlxG.width,flixel_FlxG.height,-16777216);
	this.daBg.set_antialiasing(true);
	this.add(this.daBg);
	this.daBg.set_visible(false);
	...
	if(this.blackListed.indexOf(PlayState.SONG.song.toLowerCase()) == -1) {
		...
		this.box.set_x(flixel_FlxG.width / 2 - this.box.get_width() / 2);
	}
	...
	if(this.blackListed.indexOf(PlayState.SONG.song.toLowerCase()) != -1) {
		var _g = this.box;
		_g.set_y(_g.y - this.box.get_height());
		var _g = this.box;
		_g.set_y(_g.y + 20);
		var _g = this.box;
		_g.set_x(_g.x + 40);
	...
	while(_g < 10) {
		var i = _g++;
		var isRight = false;
		var rightInts = [1,2,3,4,5,6];
		if(rightInts.indexOf(i) != -1) {
			isRight = true;
		}
		var prefix = "tabi/dialogue/Dialog icons/";
		var newSprite = new flixel_FlxSprite(this.box.x,this.box.y + 100).loadGraphic(Paths.getPath("images/" + (prefix + this.extraCharnames[i]) + ".png","IMAGE",null));
		var _g1 = newSprite;
		_g1.set_y(_g1.y - newSprite.get_height());
		if(isRight) {
			var _g2 = newSprite;
			_g2.set_x(_g2.x + this.box.get_width());
			var _g3 = newSprite;
			_g3.set_x(_g3.x - newSprite.get_width());
			var _g4 = newSprite;
			_g4.set_x(_g4.x - 100);
		} else {
			var _g5 = newSprite;
		...
		if(StringTools.startsWith(this.extraCharnames[i],"bf")) {
			var _g6 = newSprite;
			_g6.set_y(_g6.y + 30);
		}
		newSprite.updateHitbox();
		newSprite.scrollFactor.set();
		newSprite.set_visible(false);
		this.extraPortraits.push(newSprite);
		this.add(this.extraPortraits[i]);
		this.extraRights.push(isRight);
	}
	this.add(this.box);
	...
	if(this.blackListed.indexOf(PlayState.SONG.song.toLowerCase()) == -1) {
		...
		this.swagDialogue.setFormat("assets/fonts/" + "15111.ttf",daFontSize,-12640223,"left");
	}
	...
	this.blackScreen.set_antialiasing(true);
...
DialogueBox.prototype = $extend(flixel_group_FlxTypedSpriteGroup.prototype,{
	...
	,update: function(elapsed) {
		var _gthis = this;
		if(this.blackListed.indexOf(PlayState.SONG.song.toLowerCase()) != -1) {
			this.dropText.set_visible(false);
			this.dropText.set_alpha(0);
		}
		...
		if(!this.paused && !this.isFade && this.whitelisted.indexOf(this.curCharacter) == -1) {
			this.box.set_alpha(1);
			this.swagDialogue.set_alpha(1);
		} else {
			this.box.set_alpha(0);
			this.swagDialogue.set_alpha(0);
		}
		this.whitelisted = ["chromeoffset","soundoverwritestop","musicstop","music","musicloop","soundoverwrite","sound","class","class-use","bg","bghide","makeGraphic","enableTypeSound","disableTypeSound","switchSound","fadeIn","fadeOut"];
		if(PlayerSettings.player1.controls._accept.check() || this.dialogueList.length > 0 && this.whitelisted.indexOf(this.curCharacter) != -1 && this.dialogueStarted == true && !this.paused && !this.isFade) {
			var queuePause = false;
			this.queueFade = false;
			if(!this.paused && !this.isFade) {
				switch(this.curCharacter) {
				case "bg":
					if(Paths.exists(Paths.getPath("images/" + this.dialogueList[0] + ".png","IMAGE",null))) {
						this.daBg.loadGraphic(Paths.getPath("images/" + this.dialogueList[0] + ".png","IMAGE",null));
					}
					this.daBg.set_visible(true);
					break;
				case "bghide":
					this.daBg.set_visible(false);
					break;
				case "chromeoffset":
					var chromeOffset = parseFloat(this.dialogueList[0]);
					chromeOffset /= 1000;
					ChromaHandler.setChrome(chromeOffset);
					break;
				case "class":
					var ourArr = [];
					var tempShit = new EReg(",","g").split(this.dialogueList[0]);
					var _g = 0;
					while(_g < tempShit.length) {
						var shit = tempShit[_g];
						++_g;
						ourArr.push(shit);
					}
					if(ourArr.length == 2) {
						this.classAssign(ourArr[0],ourArr);
					}
					break;
				case "class-use":
					var ourArr = [];
				...
				case "fadeColor":
					...
					if(ourArr.length == 4) {
						...
						if(canUse) {
							this.fadeColor = (ourArr[0] & 255) << 24 | (ourArr[1] & 255) << 16 | (ourArr[2] & 255) << 8 | ourArr[3] & 255;
						}
					}
					break;
				case "fadeIn":
					this.queueFade = true;
					this.get_camera().fade(this.fadeColor,parseFloat(this.dialogueList[0]),false,function() {
						_gthis.isFade = false;
						_gthis.queueFade = false;
					},true);
					this.box.set_alpha(0);
					this.swagDialogue.set_alpha(0);
					break;
				case "fadeOut":
					this.queueFade = true;
					this.get_camera().fade(this.fadeColor,parseFloat(this.dialogueList[0]),true,function() {
						_gthis.isFade = false;
						_gthis.queueFade = false;
					},true);
					this.box.set_alpha(0);
				...
				case "makeGraphic":
					...
					if(ourArr.length == 4) {
						...
						if(canUse) {
							var PACKED_COLOR = (ourArr[0] & 255) << 24 | (ourArr[1] & 255) << 16 | (ourArr[2] & 255) << 8 | ourArr[3] & 255;
							this.daBg.makeGraphic(flixel_FlxG.width,flixel_FlxG.height,PACKED_COLOR);
							this.daBg.set_visible(true);
						}
					}
					break;
				case "music":
					if(Paths.exists(Paths.getPath("music/" + this.dialogueList[0] + "." + "mp3","MUSIC",null))) {
						flixel_FlxG.sound.playMusic(Paths.getPath("music/" + this.dialogueList[0] + "." + "mp3","MUSIC",null),1,false);
					}
					break;
				case "musicloop":
					if(Paths.exists(Paths.getPath("music/" + this.dialogueList[0] + "." + "mp3","MUSIC",null))) {
						flixel_FlxG.sound.playMusic(Paths.getPath("music/" + this.dialogueList[0] + "." + "mp3","MUSIC",null),1,true);
					}
					break;
				case "musicstop":
					if(flixel_FlxG.sound.music._channel != null) {
					...
					break;
				case "sound":
					if(Paths.exists(Paths.sound(this.dialogueList[0]))) {
						flixel_FlxG.sound.play(Paths.sound(this.dialogueList[0]));
					}
					break;
				case "soundoverwrite":
					if(Paths.exists(Paths.sound(this.dialogueList[0]))) {
						if(this.curSound != null && this.curSound._channel != null) {
							var _this = this.curSound;
							_this.cleanup(_this.autoDestroy,true);
						}
						this.curSound = new flixel_system_FlxSound().loadEmbedded(Paths.sound(this.dialogueList[0]));
						this.curSound.play();
					}
					break;
				...
				case "switchSound":
					if(Paths.exists(Paths.sound(this.dialogueList[0]))) {
						this.defaultSound = this.dialogueList[0];
					}
					break;
				}
				if(this.whitelisted.indexOf(this.curCharacter) != -1) {
					this.box.set_alpha(0);
					this.swagDialogue.set_alpha(0);
				}
			...
			if(this.dialogueList[1] == null && this.dialogueList[0] != null) {
				if(!this.isEnding && !this.paused && !this.isFade) {
					this.isEnding = true;
			...
			} else if(!this.paused && !this.isFade) {
				this.dropText.set_visible(true);
				this.box.set_visible(true);
				this.swagDialogue.set_visible(true);
				HxOverrides.remove(this.dialogueList,this.dialogueList[0]);
				this.startDialogue();
			} else if(this.paused || this.isFade) {
				this.dropText.set_visible(false);
				this.box.set_visible(false);
				this.swagDialogue.set_visible(false);
				this.hidePortraits();
			}
			if(queuePause) {
				queuePause = false;
	...
	,hidePortraits: function() {
		this.portraitLeft.set_visible(false);
		this.portraitRight.set_visible(false);
		var _g = 0;
		var _g1 = this.extraPortraits;
		while(_g < _g1.length) {
			var shit = _g1[_g];
			++_g;
	...
	,startDialogue: function() {
		...
		if(this.blackListed.indexOf(PlayState.SONG.song.toLowerCase()) != -1) {
			if(this.swagDialogue.sounds != [flixel_FlxG.sound.load(Paths.sound(this.defaultSound),0.6)]) {
				var tmp = flixel_FlxG.sound.load(Paths.sound(this.defaultSound),0.6);
				this.swagDialogue.sounds = [tmp];
			}
			if(!this.enableTypeSound || this.whitelisted.indexOf(this.curCharacter) != -1) {
				var tmp = flixel_FlxG.sound.load(Paths.sound(this.defaultSound),0);
				this.swagDialogue.sounds = [tmp];
			}
		}
		...
		if(this.extraCharnames.indexOf(this.curCharacter) != -1) {
			this.hidePortraits();
			this.extraPortraits[this.extraCharnames.indexOf(this.curCharacter)].set_visible(true);
			if(!this.extraRights[this.extraCharnames.indexOf(this.curCharacter)]) {
	...
	,__properties__: $extend(flixel_group_FlxTypedSpriteGroup.prototype.__properties__,{get_controls:"get_controls"})
});
...
var EffectsMenu = function(TransIn,TransOut) {
	this.curPlaying = false;
	this.curSelected = 0;
	this.songs = [];
	MusicBeatState.call(this,TransIn,TransOut);
};
$hxClasses["EffectsMenu"] = EffectsMenu;
EffectsMenu.__name__ = "EffectsMenu";
EffectsMenu.__super__ = MusicBeatState;
EffectsMenu.prototype = $extend(MusicBeatState.prototype,{
	songs: null
	,selector: null
	,curSelected: null
	,grpSongs: null
	...
	,create: function() {
		...
		this.fuckTheClearance();
		if(flixel_FlxG.sound.music._channel == null) {
			flixel_FlxG.sound.playMusic(Paths.getPath("music/" + "brosucks" + "." + "mp3","MUSIC",null),0,true);
			var _this = flixel_FlxG.sound.music;
			var Duration = 2;
			var From = 0;
			var To = 0.8;
	...
	,fuckTheClearance: function() {
		this.remove(this.grpSongs);
		this.grpSongs = new flixel_group_FlxTypedGroup();
		this.songs.splice(0,this.songs.length);
		this.add(this.grpSongs);
		var ourFuckingList = Highscore.getEffectKeys();
		var fuckingBool = [];
		var myFuckingList = Highscore.getEffects();
		var _g = 0;
		while(_g < ourFuckingList.length) {
			var shit = ourFuckingList[_g];
			++_g;
			var finalShit = StringTools.replace(shit,"2"," TWO ");
			if(myFuckingList.indexOf(shit) != -1) {
				finalShit += " ON";
			} else {
				finalShit += " OFF";
			}
			this.songs.push(new SongMetadata(finalShit,1,"gf"));
		}
		var _g = 0;
		while(_g < ourFuckingList.length) {
			var daItem = ourFuckingList[_g];
			++_g;
			if(myFuckingList.indexOf(daItem) != -1) {
	...
	,update: function(elapsed) {
		...
		if(Highscore.getInput() && flixel_FlxG.mouse.wheel != 0) {
			this.changeSelection(flixel_FlxG.mouse.wheel * -1);
		}
		if(PlayerSettings.player1.controls._back.check()) {
			var nextState = new SettingsMenu();
			if(flixel_FlxG.game._state.switchTo(nextState)) {
				flixel_FlxG.game._requestedState = nextState;
			}
		}
		if(accepted) {
			Highscore.toggleEffect(this.curSelected);
			this.fuckTheClearance();
		}
	}
