...
var AnimationDebug = function(daAnim) {
	if(daAnim == null) {
		daAnim = "spooky";
	}
	this.daAnim = "spooky";
...
$hxClasses["AnimationDebug"] = AnimationDebug;
AnimationDebug.__name__ = "AnimationDebug";
AnimationDebug.__super__ = flixel_FlxState;
AnimationDebug.prototype = $extend(flixel_FlxState.prototype,{
	bf: null
	,dad: null
	,char: null
	,textAnim: null
	...
	,updateTexts: function() {
		var _gthis = this;
		this.dumbTexts.forEach(function(text) {
			text.kill();
			_gthis.dumbTexts.remove(text,true);
		});
	}
	,update: function(elapsed) {
		this.textAnim.set_text(this.char.animation._curAnim.name);
		var _this = flixel_FlxG.keys.justPressed;
		if(_this.keyManager.checkStatus(69,_this.status)) {
			var _g = flixel_FlxG.camera;
			_g.set_zoom(_g.zoom + 0.25);
		}
		var _this = flixel_FlxG.keys.justPressed;
		...
		if(!_this.keyManager.checkStatus(73,_this.status)) {
			var _this = flixel_FlxG.keys.pressed;
			tmp2 = _this.keyManager.checkStatus(74,_this.status);
		} else {
			tmp2 = true;
		}
		if(!tmp2) {
			var _this = flixel_FlxG.keys.pressed;
			tmp1 = _this.keyManager.checkStatus(75,_this.status);
		} else {
			tmp1 = true;
		}
		if(!tmp1) {
			var _this = flixel_FlxG.keys.pressed;
			tmp = _this.keyManager.checkStatus(76,_this.status);
		} else {
			tmp = true;
		}
		if(tmp) {
			var _this = flixel_FlxG.keys.pressed;
			if(_this.keyManager.checkStatus(73,_this.status)) {
				this.camFollow.velocity.set_y(-90);
			} else {
				var _this = flixel_FlxG.keys.pressed;
				if(_this.keyManager.checkStatus(75,_this.status)) {
					this.camFollow.velocity.set_y(90);
				} else {
					this.camFollow.velocity.set_y(0);
				}
			}
			var _this = flixel_FlxG.keys.pressed;
			if(_this.keyManager.checkStatus(74,_this.status)) {
				this.camFollow.velocity.set_x(-90);
			} else {
				var _this = flixel_FlxG.keys.pressed;
				if(_this.keyManager.checkStatus(76,_this.status)) {
					this.camFollow.velocity.set_x(90);
				} else {
					this.camFollow.velocity.set_x(0);
				}
			}
		} else {
			this.camFollow.velocity.set();
		}
		var _this = flixel_FlxG.keys.justPressed;
		...
		if(!_this.keyManager.checkStatus(83,_this.status)) {
			var _this = flixel_FlxG.keys.justPressed;
			tmp1 = _this.keyManager.checkStatus(87,_this.status);
		} else {
			tmp1 = true;
		}
		if(!tmp1) {
		...
		var upP = flixel_FlxG.keys.checkKeyArrayState([38],2);
		var rightP = flixel_FlxG.keys.checkKeyArrayState([39],2);
		var downP = flixel_FlxG.keys.checkKeyArrayState([40],2);
		var leftP = flixel_FlxG.keys.checkKeyArrayState([37],2);
		var _this = flixel_FlxG.keys.pressed;
		var holdShift = _this.keyManager.checkStatus(16,_this.status);
		var multiplier = 1;
		if(holdShift) {
			multiplier = 10;
		}
		if(upP || rightP || downP || leftP) {
			this.updateTexts();
			if(upP) {
				this.char.animOffsets.h[this.animList[this.curAnim]][1] += multiplier;
			}
			if(downP) {
				this.char.animOffsets.h[this.animList[this.curAnim]][1] -= multiplier;
			}
			if(leftP) {
				this.char.animOffsets.h[this.animList[this.curAnim]][0] += multiplier;
			}
			if(rightP) {
				this.char.animOffsets.h[this.animList[this.curAnim]][0] -= multiplier;
			}
...
var Character = function(x,y,character,isPlayer) {
	...
	this.danced = false;
	this.tordCam = [new flixel_math_FlxPoint(391.2,-1094.15),new flixel_math_FlxPoint(290.9,-1094.15),new flixel_math_FlxPoint(450.9,-1094.15),new flixel_math_FlxPoint(374.9,-1174.15),new flixel_math_FlxPoint(570.9,-974.15)];
	this.holdTimer = 0;
	...
	case "tord":
		var library = null;
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "tord/tord_assets" + ".png","IMAGE",library),Paths.getPath("images/" + "tord/tord_assets" + ".xml","TEXT",library));
		this.set_frames(tex);
		haxe_Log.trace("got texture",{ fileName : "source/Character.hx", lineNumber : 187, className : "Character", methodName : "new"});
		this.animation.addByPrefix("idle","tord idle",24,false);
		this.animation.addByPrefix("singUP","tord up",24,false);
		this.animation.addByPrefix("singDOWN","tord down",24,false);
		this.animation.addByPrefix("singLEFT","tord left",24,false);
		this.animation.addByPrefix("singRIGHT","tord right",24,false);
		haxe_Log.trace("got anims",{ fileName : "source/Character.hx", lineNumber : 196, className : "Character", methodName : "new"});
		this.addOffset("idle");
		this.addOffset("singDOWN",-4,-21);
		this.addOffset("singRIGHT",-30,-13);
		this.addOffset("singUP",9,21);
		this.addOffset("singLEFT",20,-17);
		this.playAnim("idle");
		break;
	case "tordbot":
		var library = null;
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "tord/tordbot_assets" + ".png","IMAGE",library),Paths.getPath("images/" + "tord/tordbot_assets" + ".xml","TEXT",library));
		this.set_frames(tex);
		haxe_Log.trace("got texture",{ fileName : "source/Character.hx", lineNumber : 207, className : "Character", methodName : "new"});
		this.animation.addByPrefix("idle","tordbot idle",24,false);
		this.animation.addByPrefix("singUP","tordbot up",24,false);
		this.animation.addByPrefix("singDOWN","tordbot down",24,false);
		this.animation.addByPrefix("singLEFT","tordbot left",24,false);
		this.animation.addByPrefix("singRIGHT","tordbot right",24,false);
		haxe_Log.trace("got anims",{ fileName : "source/Character.hx", lineNumber : 216, className : "Character", methodName : "new"});
		this.addOffset("idle");
		this.addOffset("singRIGHT",-20,-20);
		this.addOffset("singDOWN",-10,-90);
		this.addOffset("singLEFT",-90);
		this.addOffset("singUP",-30,29);
		this.playAnim("idle");
		break;
	}
	this.dance();
...
Character.prototype = $extend(flixel_FlxSprite.prototype,{
	...
	,playAnim: function(AnimName,Force,Reversed,Frame) {
		...
		if(this.curCharacter == "tordbot") {
			if(AnimName == "singLEFT") {
				PlayState.camFollow.setPosition(this.tordCam[0].x,this.tordCam[0].y);
			}
			if(AnimName == "singRIGHT") {
				PlayState.camFollow.setPosition(this.tordCam[1].x,this.tordCam[1].y);
			}
			if(AnimName == "singUP") {
				PlayState.camFollow.setPosition(this.tordCam[2].x,this.tordCam[2].y);
			}
			if(AnimName == "singDOWN") {
				PlayState.camFollow.setPosition(this.tordCam[3].x,this.tordCam[3].y);
			}
		}
	}
...
ChartingState.prototype = $extend(MusicBeatState.prototype,{
	...
	,addSongUI: function() {
		...
		check_voices.callback = function() {
			...
			haxe_Log.trace("CHECKED!",{ fileName : "source/ChartingState.hx", lineNumber : 190, className : "ChartingState", methodName : "addSongUI"});
		};
		...
		var restart = new flixel_ui_FlxButton(10,140,"Reset",function() {
			var _g = 0;
	...
	,update: function(elapsed) {
				...
				if(controlArray[i]) {
					...
					while(_g2 < _g3) {
						...
						if(note[0] == Conductor.songPosition && note[1] % 4 == i) {
							haxe_Log.trace("GAMING",{ fileName : "source/ChartingState.hx", lineNumber : 545, className : "ChartingState", methodName : "update"});
							HxOverrides.remove(this._song.notes[this.curSection].sectionNotes,note);
						}
					}
					haxe_Log.trace("adding note",{ fileName : "source/ChartingState.hx", lineNumber : 549, className : "ChartingState", methodName : "update"});
		...
		if(this.curBeat % 4 == 0 && this.curStep >= 16 * (this.curSection + 1)) {
			haxe_Log.trace(this.curStep,{ fileName : "source/ChartingState.hx", lineNumber : 561, className : "ChartingState", methodName : "update"});
			haxe_Log.trace(this._song.notes[this.curSection].lengthInSteps * (this.curSection + 1),{ fileName : "source/ChartingState.hx", lineNumber : 562, className : "ChartingState", methodName : "update"});
			haxe_Log.trace("DUMBSHIT",{ fileName : "source/ChartingState.hx", lineNumber : 563, className : "ChartingState", methodName : "update"});
				...
				this.curRenderedNotes.forEach(function(note) {
					if(flixel_FlxG.mouse.overlaps(note)) {
						...
						if(_this.keyManager.checkStatus(17,_this.status)) {
							...
							haxe_Log.trace("tryin to delete note",{ fileName : "source/ChartingState.hx", lineNumber : 590, className : "ChartingState", methodName : "update"});
							haxe_Log.trace(note.noteData,{ fileName : "source/ChartingState.hx", lineNumber : 591, className : "ChartingState", methodName : "update"});
	...
	,changeSection: function(sec,updateMusic) {
		...
		haxe_Log.trace("changing section" + sec,{ fileName : "source/ChartingState.hx", lineNumber : 816, className : "ChartingState", methodName : "changeSection"});
		if(this._song.notes[sec] != null) {
			haxe_Log.trace("naw im not null",{ fileName : "source/ChartingState.hx", lineNumber : 820, className : "ChartingState", methodName : "changeSection"});
			this.curSection = sec;
			this.updateGrid();
			if(updateMusic) {
				flixel_FlxG.sound.music.pause();
			...
			haxe_Log.trace("bro wtf I AM NULL",{ fileName : "source/ChartingState.hx", lineNumber : 847, className : "ChartingState", methodName : "changeSection"});
		}
	}
	...
	,deleteNote: function(note) {
		haxe_Log.trace(this._song.notes[this.curSection].sectionNotes,{ fileName : "source/ChartingState.hx", lineNumber : 1008, className : "ChartingState", methodName : "deleteNote"});
		var _g = 0;
		var _g1 = this._song.notes[this.curSection].sectionNotes.length;
		while(_g < _g1) {
			var n = _g++;
			var i = this._song.notes[this.curSection].sectionNotes[n];
			if(i == null) {
				continue;
			}
			if((i[0] == note.strumTime + (note.strumTime == 0 ? 0 : 1) ? true : i[0] == note.strumTime) && i[1] % 4 == note.noteData) {
				haxe_Log.trace("GAMING",{ fileName : "source/ChartingState.hx", lineNumber : 1020, className : "ChartingState", methodName : "deleteNote"});
	...
	,addNote: function() {
		...
		haxe_Log.trace(noteStrum,{ fileName : "source/ChartingState.hx", lineNumber : 1060, className : "ChartingState", methodName : "addNote"});
		haxe_Log.trace(this.curSection,{ fileName : "source/ChartingState.hx", lineNumber : 1061, className : "ChartingState", methodName : "addNote"});
		this.updateGrid();
		this.updateNoteUI();
		this.autosaveSong();
	}
	...
	,daSpacing: null
	,loadLevel: function() {
		haxe_Log.trace(this._song.notes,{ fileName : "source/ChartingState.hx", lineNumber : 1106, className : "ChartingState", methodName : "loadLevel"});
	}
	,getNotes: function() {
		var noteData = [];
		var _g = 0;
...
FreeplayState.prototype = $extend(MusicBeatState.prototype,{
	...
	,update: function(elapsed) {
		...
		if(accepted) {
			...
			haxe_Log.trace(poop,{ fileName : "source/FreeplayState.hx", lineNumber : 215, className : "FreeplayState", methodName : "update"});
			...
			haxe_Log.trace("CUR WEEK" + PlayState.storyWeek,{ fileName : "source/FreeplayState.hx", lineNumber : 222, className : "FreeplayState", methodName : "update"});
...
var HealthIcon = function(char,isPlayer) {
	...
	this.animation.add("tord",[24,25],0,false,isPlayer);
	this.animation.add("tordbot",[26,27],0,false,isPlayer);
...
KadeEngineData.initSave = function() {
	...
	if(flixel_FlxG.save.data.etternaMode == null) {
		flixel_FlxG.save.data.etternaMode = false;
	}
};
var Lambda = function() { };
...
MainMenuState.prototype = $extend(MusicBeatState.prototype,{
	...
	,create: function() {
		...
		var versionShit = new flixel_text_FlxText(5,flixel_FlxG.height - 18,0,MainMenuState.gameVer + " FNF - " + MainMenuState.kadeEngineVer + " Kade Engine",12);
						...
						if(_gthis.curSelected != spr.ID) {
							...
							flixel_effects_FlxFlicker.flicker(spr,1,0.06,false,false,function(flick) {
								...
								case "freeplay":
									...
									haxe_Log.trace("Freeplay Menu Selected",{ fileName : "source/MainMenuState.hx", lineNumber : 193, className : "MainMenuState", methodName : "update"});
									break;
								case "options":
									var nextState = new OptionsMenu();
									if(flixel_FlxG.game._state.switchTo(nextState)) {
								...
								case "story mode":
									...
									haxe_Log.trace("Story Menu Selected",{ fileName : "source/MainMenuState.hx", lineNumber : 189, className : "MainMenuState", methodName : "update"});
									break;
								}
							});
						}
...
ManifestResources.init = function(config) {
	...
	var data = "{\"name\":null,\"assets\":\"aoy4:pathy43:assets%2Fdata%2Fblammed%2Fblammed-easy.jsony4:sizei39025y4:typey4:TEXTy2:idR1y7:preloadtgoR0y43:assets%2Fdata%2Fblammed%2Fblammed-hard.jsonR2i53646R3R4R5R7R6tgoR0y38:assets%2Fdata%2Fblammed%2Fblammed.jsonR2i44638R3R4R5R8R6tgoR0y43:assets%2Fdata%2Fbopeebo%2Fbopeebo-easy.jsonR2i6561R3R4R5R9R6tgoR0y43:assets%2Fdata%2Fbopeebo%2Fbopeebo-hard.jsonR2i6564R3R4R5R10R6tgoR0y38:assets%2Fdata%2Fbopeebo%2Fbopeebo.jsonR2i6561R3R4R5R11R6tgoR0y33:assets%2Fdata%2FcharacterList.txtR2i159R3R4R5R12R6tgoR0y39:assets%2Fdata%2Fcocoa%2Fcocoa-easy.jsonR2i27364R3R4R5R13R6tgoR0y39:assets%2Fdata%2Fcocoa%2Fcocoa-hard.jsonR2i22841R3R4R5R14R6tgoR0y34:assets%2Fdata%2Fcocoa%2Fcocoa.jsonR2i30208R3R4R5R15R6tgoR0y28:assets%2Fdata%2Fcontrols.txtR2i324R3R4R5R16R6tgoR0y47:assets%2Fdata%2Fdadbattle%2Fdadbattle-easy.jsonR2i28153R3R4R5R17R6tgoR0y47:assets%2Fdata%2Fdadbattle%2Fdadbattle-hard.jsonR2i34945R3R4R5R18R6tgoR0y42:assets%2Fdata%2Fdadbattle%2Fdadbattle.jsonR2i30225R3R4R5R19R6tgoR0y34:assets%2Fdata%2Fdata-goes-here.txtR2zR3R4R5R20R6tgoR0y41:assets%2Fdata%2Feggnog%2Feggnog-easy.jsonR2i32768R3R4R5R21R6tgoR0y41:assets%2Fdata%2Feggnog%2Feggnog-hard.jsonR2i141118R3R4R5R22R6tgoR0y36:assets%2Fdata%2Feggnog%2Feggnog.jsonR2i35674R3R4R5R23R6tgoR0y36:assets%2Fdata%2FfreeplaySonglist.txtR2i23R3R4R5R24R6tgoR0y39:assets%2Fdata%2Ffresh%2Ffresh-easy.jsonR2i17647R3R4R5R25R6tgoR0y39:assets%2Fdata%2Ffresh%2Ffresh-hard.jsonR2i19185R3R4R5R26R6tgoR0y34:assets%2Fdata%2Ffresh%2Ffresh.jsonR2i18849R3R4R5R27R6tgoR0y37:assets%2Fdata%2Fhigh%2Fhigh-easy.jsonR2i34032R3R4R5R28R6tgoR0y37:assets%2Fdata%2Fhigh%2Fhigh-hard.jsonR2i26047R3R4R5R29R6tgoR0y32:assets%2Fdata%2Fhigh%2Fhigh.jsonR2i36383R3R4R5R30R6tgoR0y29:assets%2Fdata%2FintroText.txtR2i1260R3R4R5R31R6tgoR0y29:assets%2Fdata%2Fmain-view.xmlR2i123R3R4R5R32R6tgoR0y37:assets%2Fdata%2Fmilf%2Fmilf