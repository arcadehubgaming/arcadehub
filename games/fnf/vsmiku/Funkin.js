...
var Character = function(x,y,character,isPlayer) {
	...
	case "bf":
		...
		this.animation.addByPrefix("shock","BF hit",24,false);
	...
	case "bf-pixel-dead":
		...
		break;
	case "dad":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "DADDY_DEAREST" + ".png","IMAGE","shared"),Paths.getPath("images/" + "DADDY_DEAREST" + ".xml","TEXT","shared"));
		this.set_frames(tex);
	...
	case "gf-pixel":
		...
		break;
	case "miku":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "ev_miku_assets" + ".png","IMAGE","shared"),Paths.getPath("images/" + "ev_miku_assets" + ".xml","TEXT","shared"));
		this.set_frames(tex);
		this.animation.addByPrefix("idle","Miku idle dance",24);
		this.animation.addByPrefix("singUP","Miku Sing Note UP",24);
		this.animation.addByPrefix("singRIGHT","Miku Sing Note RIGHT",24);
		this.animation.addByPrefix("singDOWN","Miku Sing Note DOWN",24);
		this.animation.addByPrefix("singLEFT","Miku Sing Note LEFT",24);
		this.addOffset("idle");
		this.addOffset("singUP",0,50);
		this.addOffset("singRIGHT",0,25);
		this.addOffset("singLEFT",20,10);
		this.addOffset("singDOWN",0,-30);
		this.playAnim("idle");
		break;
	case "miku-mad":
		this.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "ev_miku_mad" + ".png","IMAGE","shared"),Paths.getPath("images/" + "ev_miku_mad" + ".xml","TEXT","shared")));
		this.animation.addByPrefix("idle","Miku idle dance",24,false);
		this.animation.addByPrefix("singUP","Miku Sing Note UP",24,false);
		this.animation.addByPrefix("singDOWN","Miku Sing Note DOWN",24,false);
		this.animation.addByPrefix("singLEFT","Miku Sing Note LEFT",24,false);
		this.animation.addByPrefix("singRIGHT","Miku Sing Note RIGHT",24,false);
		this.animation.addByPrefix("singUP-alt","Miku Scream Sing Note UP",24,false);
		this.animation.addByPrefix("singDOWN-alt","Miku Scream Sing Note DOWN",24,false);
		this.animation.addByPrefix("singLEFT-alt","Miku Scream Sing Note LEFT",24,false);
		this.animation.addByPrefix("singRIGHT-alt","Miku Scream Sing Note RIGHT",24,false);
		this.addOffset("idle");
		this.addOffset("singUP",0,0);
		this.addOffset("singRIGHT",-1,0);
		this.addOffset("singLEFT",20,0);
		this.addOffset("singDOWN",0,0);
		...
		this.playAnim("idle");
		break;
	case "mikudropthemike":
		this.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "mikumadone" + ".png","IMAGE","shared"),Paths.getPath("images/" + "mikumadone" + ".xml","TEXT","shared")));
		this.animation.addByPrefix("idle","miku intro challenge 1",24,false);
		break;
	case "mikuintro":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "mikuintro" + ".png","IMAGE","shared"),Paths.getPath("images/" + "mikuintro" + ".xml","TEXT","shared"));
		this.set_frames(tex);
		this.animation.addByPrefix("idle","miku intro instance 1",24);
		break;
	case "mom":
		var library = null;
...
MusicBeatState.prototype = $extend(flixel_addons_ui_FlxUIState.prototype,{
	...
	,create: function() {
		if(this.transIn != null) {
			haxe_Log.trace("reg " + Std.string(this.transIn.region),{ fileName : "source/MusicBeatState.hx", lineNumber : 28, className : "MusicBeatState", methodName : "create"});
		}
...
FreeplayState.prototype = $extend(MusicBeatState.prototype,{
	...
	,create: function() {
		...
		var isDebug = false;
		this.addWeek(["popipo","aishite","siu"],1,["miku"]);
		this.addWeek(["disappearance"],1,["miku-mad"]);
		this.addWeek(["chug"],1,["miku"]);
	...
	,update: function(elapsed) {
		...
		if(accepted) {
			...
			haxe_Log.trace(poop,{ fileName : "source/FreeplayState.hx", lineNumber : 210, className : "FreeplayState", methodName : "update"});
			...
			haxe_Log.trace("CUR WEEK" + PlayState.storyWeek,{ fileName : "source/FreeplayState.hx", lineNumber : 217, className : "FreeplayState", methodName : "update"});
...
GameplayCustomizeState.prototype = $extend(MusicBeatState.prototype,{
	...
	,beatHit: function() {
		...
		haxe_Log.trace("beat",{ fileName : "source/GameplayCustomizeState.hx", lineNumber : 151, className : "GameplayCustomizeState", methodName : "beatHit"});
	}
...
var HealthIcon = function(char,isPlayer) {
	...
	haxe_Log.trace(Paths.getPath("images/" + "iconGrid" + ".png","IMAGE","data"),{ fileName : "source/HealthIcon.hx", lineNumber : 15, className : "HealthIcon", methodName : "new"});
	...
	this.animation.add("miku",[10,11],0,false,isPlayer);
	this.animation.add("mikuintro",[10,11],0,false,isPlayer);
	this.animation.add("miku-mad",[24,25],0,false,isPlayer);
	this.animation.add("mikudropthemike",[24,25],0,false,isPlayer);
						...
						if(_gthis.curSelected != spr.ID) {
							...
							flixel_effects_FlxFlicker.flicker(spr,1,0.06,false,false,function(flick) {
								...
								case "freeplay":
									...
									haxe_Log.trace("Freeplay Menu Selected",{ fileName : "source/MainMenuState.hx", lineNumber : 195, className : "MainMenuState", methodName : "update"});
									break;
								case "options":
									var nextState = new OptionsMenu();
									if(flixel_FlxG.game._state.switchTo(nextState)) {
								...
								case "story mode":
									...
									haxe_Log.trace("Story Menu Selected",{ fileName : "source/MainMenuState.hx", lineNumber : 191, className : "MainMenuState", methodName : "update"});
									break;
								}
							});
						}
...
ManifestResources.init = function(config) {
	...
	var data = "{\"name\":null,\"assets\":\"aoy4:pathy43:assets%2Fdata%2Faishite%2Faishite-easy.jsony4:sizei13288y4:typey4:TEXTy2:idR1y7:preloadtgoR0y43:assets%2Fdata%2Faishite%2Faishite-hard.jsonR2i16679R3R4R5R7R6tgoR0y38:assets%2Fdata%2Faishite%2Faishite.jsonR2i15494R3R4R5R8R6tgoR0y43:assets%2Fdata%2Fblammed%2Fblammed-easy.jsonR2i39025R3R4R5R9R6tgoR0y43:assets%2Fdata%2Fblammed%2Fblammed-hard.jsonR2i53646R3R4R5R10R6tgoR0y38:assets%2Fdata%2Fblammed%2Fblammed.jsonR2i44638R3R4R5R11R6tgoR0y43:assets%2Fdata%2Fbopeebo%2Fbopeebo-easy.jsonR2i6561R3R4R5R12R6tgoR0y43:assets%2Fdata%2Fbopeebo%2Fbopeebo-hard.jsonR2i6564R3R4R5R13R6tgoR0y38:assets%2Fdata%2Fbopeebo%2Fbopeebo.jsonR2i6561R3R4R5R14R6tgoR0y33:assets%2Fdata%2FcharacterList.txtR2i146R3R4R5R15R6tgoR0y37:assets%2Fdata%2Fchug%2Fchug-easy.jsonR2i6671R3R4R5R16R6tgoR0y37:assets%2Fdata%2Fchug%2Fchug-hard.jsonR2i6671R3R4R5R17R6tgoR0y32:assets%2Fdata%2Fchug%2Fchug.jsonR2i6671R3R4R5R18R6tgoR0y39:assets%2Fdata%2Fcocoa%2Fcocoa