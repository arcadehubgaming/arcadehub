...
Alphabet.prototype = $extend(flixel_group_FlxTypedSpriteGroup.prototype,{
	...
	,startTypedText: function() {
		...
		new flixel_util_FlxTimer().start(0.05,function(tmr) {
			...
			haxe_Log.trace(_gthis.splitWords[loopNum] + " | " + (isNumber == null ? "null" : "" + isNumber) + " | " + (isSymbol == null ? "null" : "" + isSymbol),{ fileName : "source/Alphabet.hx", lineNumber : 155, className : "Alphabet", methodName : "startTypedText"});
...
var Character = function(x,y,character,isPlayer) {
	...
	case "bf":
		...
		break;
	case "bf-bside":
		var tex1 = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "bSide/BOYFRIEND" + ".png","IMAGE","bonusWeek"),Paths.getPath("images/" + "bSide/BOYFRIEND" + ".xml","TEXT","bonusWeek"));
		this.set_frames(tex1);
		this.animation.addByPrefix("idle","BF idle dance",24,false);
		this.animation.addByPrefix("singUP","BF NOTE UP0",24,false);
		this.animation.addByPrefix("singLEFT","BF NOTE LEFT0",24,false);
	...
	case "gf-pixel":
		...
		break;
	case "gf-whitty":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "GF_Standing_Sway" + ".png","IMAGE","bonusWeek"),Paths.getPath("images/" + "GF_Standing_Sway" + ".xml","TEXT","bonusWeek"));
		this.set_frames(tex);
		this.animation.addByPrefix("sad","Sad",24,false);
		this.animation.addByPrefix("danceLeft","Idle Left",24,false);
		this.animation.addByPrefix("danceRight","Idle Right",24,false);
		this.animation.addByPrefix("scared","Scared",24,false);
		this.addOffset("sad",-140,-153);
		this.addOffset("danceLeft",-140,-153);
		this.addOffset("danceRight",-140,-153);
		this.addOffset("scared",-140,-153);
		this.playAnim("danceRight");
		break;
	case "gf-whitty-bside":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "gf_whitty_bside" + ".png","IMAGE","bonusWeek"),Paths.getPath("images/" + "gf_whitty_bside" + ".xml","TEXT","bonusWeek"));
		this.set_frames(tex);
		this.animation.addByPrefix("sad","Sad",24,false);
		this.animation.addByPrefix("danceLeft","Idle Left",24,false);
		this.animation.addByPrefix("danceRight","Idle Right",24,false);
		...
		break;
	case "gf-whitty-zoom":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "GF_Standing_ZOOOOOOOOOOOOOOM" + ".png","IMAGE","bonusWeek"),Paths.getPath("images/" + "GF_Standing_ZOOOOOOOOOOOOOOM" + ".xml","TEXT","bonusWeek"));
		this.set_frames(tex);
		this.animation.addByPrefix("sad","Sad",24,false);
		this.animation.addByPrefix("danceLeft","Idle Left",24,false);
		this.animation.addByPrefix("danceRight","Idle Right",24,false);
	...
	case "spooky":
		...
		break;
	case "whitty":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "WhittySprites" + ".png","IMAGE","bonusWeek"),Paths.getPath("images/" + "WhittySprites" + ".xml","TEXT","bonusWeek"));
		this.set_frames(tex);
		this.animation.addByPrefix("idle","Idle",24);
		this.animation.addByPrefix("singUP","Sing Up",24);
		this.animation.addByPrefix("singRIGHT","Sing Right",24);
		this.animation.addByPrefix("singDOWN","Sing Down",24);
		this.animation.addByPrefix("singLEFT","Sing Left",24);
		this.addOffset("idle",0,0);
		this.addOffset("singUP",-6,50);
		this.addOffset("singRIGHT",0,27);
		this.addOffset("singLEFT",-10,10);
		this.addOffset("singDOWN",0,-30);
		break;
	case "whittyBSide":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "BSideSprites" + ".png","IMAGE","bonusWeek"),Paths.getPath("images/" + "BSideSprites" + ".xml","TEXT","bonusWeek"));
		this.set_frames(tex);
		this.animation.addByPrefix("idle","Idle",24);
		this.animation.addByPrefix("singUP","Sing Up",24);
		this.animation.addByPrefix("singRIGHT","Sing Right",24);
	...
	case "whittyBSideCrazy":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "WhittyBallisitcB" + ".png","IMAGE","bonusWeek"),Paths.getPath("images/" + "WhittyBallisitcB" + ".xml","TEXT","bonusWeek"));
		this.set_frames(tex);
		this.animation.addByPrefix("idle","Whitty idle dance",24);
		this.animation.addByPrefix("singUP","Whitty Sing Note UP",24);
		this.animation.addByPrefix("singRIGHT","whitty sing note right",24);
		this.animation.addByPrefix("singDOWN","Whitty Sing Note DOWN",24);
		this.animation.addByPrefix("singLEFT","Whitty Sing Note LEFT",24);
		this.addOffset("idle",50);
		this.addOffset("singUP",50,85);
		this.addOffset("singRIGHT",100,-75);
		this.addOffset("singLEFT",50);
		this.addOffset("singDOWN",75,-150);
		break;
	case "whittyCrazy":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "WhittyCrazy" + ".png","IMAGE","bonusWeek"),Paths.getPath("images/" + "WhittyCrazy" + ".xml","TEXT","bonusWeek"));
		this.set_frames(tex);
		this.animation.addByPrefix("idle","Whitty idle dance",24);
		this.animation.addByPrefix("singUP","Whitty Sing Note UP",24);
		this.animation.addByPrefix("singRIGHT","whitty sing note right",24);
		...
		break;
	case "wide":
		tex = flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "wide" + ".png","IMAGE","bonusWeek"),Paths.getPath("images/" + "wide" + ".xml","TEXT","bonusWeek"));
		this.set_frames(tex);
		this.animation.addByPrefix("idle","Dad idle dance",24);
		this.animation.addByPrefix("singUP","Dad Sing note UP",24);
		this.animation.addByPrefix("singLEFT","dad sing note right",24);
		this.animation.addByPrefix("singDOWN","Dad Sing Note DOWN",24);
		this.animation.addByPrefix("singRIGHT","Dad Sing Note LEFT",24);
		this.addOffset("idle");
		this.addOffset("singUP");
		this.addOffset("singRIGHT");
		this.addOffset("singLEFT");
	...
	haxe_Log.trace("created character " + this.curCharacter,{ fileName : "source/Character.hx", lineNumber : 655, className : "Character", methodName : "new"});
	this.dance();
	if(isPlayer) {
...
ChartingState.prototype = $extend(MusicBeatState.prototype,{
	...
	,updateHeads: function() {
		if(this.check_mustHitSection.checked) {
			this.leftIcon.animation.play(this._song.player1);
			this.rightIcon.animation.play(this._song.player2);
		} else {
			this.leftIcon.animation.play(this._song.player2);
			this.rightIcon.animation.play(this._song.player1);
		}
	}
	...
	,daSpacing: null
	,loadLevel: function() {
		haxe_Log.trace(this._song.notes,{ fileName : "source/ChartingState.hx", lineNumber : 1309, className : "ChartingState", methodName : "loadLevel"});
	}
	,getNotes: function() {
		var noteData = [];
		var _g = 0;
...
var DialogueBox = function(talkingRight,dialogueList) {
	...
	var gaming = PlayState.SONG.song.toLowerCase() != "lo-fight" && PlayState.SONG.song.toLowerCase() != "b-lo-fight" && PlayState.SONG.song.toLowerCase() != "overhead" && PlayState.SONG.song.toLowerCase() != "b-overhead" && PlayState.SONG.song.toLowerCase() != "b-ballistic" && PlayState.SONG.song.toLowerCase() != "ballistic";
	if(gaming) {
		...
		this.bgFade = new flixel_FlxSprite(-200,-200).makeGraphic(flixel_FlxG.width * 1.3 | 0,flixel_FlxG.height * 1.3 | 0,-8355712);
		this.bgFade.scrollFactor.set();
		this.bgFade.set_alpha(0);
		this.add(this.bgFade);
		new flixel_util_FlxTimer().start(0.83,function(tmr) {
	...
	var hasDialog = false;
	switch(PlayState.SONG.song.toLowerCase()) {
	case "ballistic":case "ballistic-b-side":case "lo-fight":case "lo-fight-b-side":case "overhead":case "overhead-b-side":
		hasDialog = true;
		...
		this.box.animation.addByIndices("normal","speech bubble normal",[11],"",24);
		break;
	case "roses":
		hasDialog = true;
	...
	if(gaming) {
		...
		this.box.set_y(flixel_FlxG.height - 285);
		this.box.set_x(20);
	}
	...
	if(gaming) {
		...
		this.portraitLeft = new flixel_FlxSprite(200,flixel_FlxG.height - 525);
		this.portraitLeft.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "whittyPort" + ".png","IMAGE","bonusWeek"),Paths.getPath("images/" + "whittyPort" + ".xml","TEXT","bonusWeek")));
		switch(PlayState.SONG.song.toLowerCase()) {
		case "ballistic":
			this.portraitLeft.animation.addByPrefix("enter","Whitty Portrait Crazy",24,true);
			break;
		case "ballistic-b-side":
			this.portraitLeft.animation.addByPrefix("enter","Whitty Portrait Crazy",24,true);
			break;
		case "lo-fight":
			this.portraitLeft.animation.addByPrefix("enter","Whitty Portrait Normal",24,false);
			break;
		case "lo-fight-b-side":
			this.portraitLeft.animation.addByPrefix("enter","Whitty Portrait Normal",24,false);
			break;
		case "overhead":
			this.portraitLeft.animation.addByPrefix("enter","Whitty Portrait Agitated",24,false);
			break;
		...
		this.add(this.portraitLeft);
		this.portraitLeft.set_visible(false);
		this.portraitRight = new flixel_FlxSprite(800,flixel_FlxG.height - 489);
		this.portraitRight.set_frames(flixel_graphics_frames_FlxAtlasFrames.fromSparrow(Paths.getPath("images/" + "boyfriendPort" + ".png","IMAGE","bonusWeek"),Paths.getPath("images/" + "boyfriendPort" + ".xml","TEXT","bonusWeek")));
		this.portraitRight.animation.addByPrefix("enter","BF portrait enter",24,false);
		this.portraitRight.updateHitbox();
		this.portraitRight.scrollFactor.set();
		this.add(this.portraitRight);
		this.portraitRight.set_visible(false);
	...
	if(PlayState.SONG.song.toLowerCase() != "lo-fight" && PlayState.SONG.song.toLowerCase() != "b-lo-fight" && PlayState.SONG.song.toLowerCase() != "overhead" && PlayState.SONG.song.toLowerCase() != "b-overhead") {
		...
		var tmp = flixel_FlxG.sound.load(Paths.sound("ballistic","shared"),0.6);
		this.swagDialogue.sounds = [tmp];
	} else {
		var tmp = flixel_FlxG.sound.load(Paths.sound("whitty","shared"),0.6);
		this.swagDialogue.sounds = [tmp];
	}
	...
	,startDialogue: function() {
		...
		case "bf":
			...
			if(!this.portraitRight.visible) {
				...
				haxe_Log.trace("bf pog!!!",{ fileName : "source/DialogueBox.hx", lineNumber : 347, className : "DialogueBox", methodName : "startDialogue"});
...
FreeplayState.prototype = $extend(MusicBeatState.prototype,{
	...
	,update: function(elapsed) {
		...
		if(accepted) {
			...
			haxe_Log.trace(poop,{ fileName : "source/FreeplayState.hx", lineNumber : 203, className : "FreeplayState", methodName : "update"});
			...
			haxe_Log.trace("CUR WEEK" + PlayState.storyWeek,{ fileName : "source/FreeplayState.hx", lineNumber : 210, className : "FreeplayState", methodName : "update"});
			var nextState = LoadingState.getNextState(new PlayState(),false);
			if(flixel_FlxG.game._state.switchTo(nextState)) {
				flixel_FlxG.game._requestedState = nextState;
			}
...
var HealthIcon = function(char,isPlayer) {
	...
	this.loadGraphic(Paths.getPath("images/" + "iconGrid" + ".png","IMAGE","shared"),true,150,150);
	this.set_antialiasing(true);
	...
	this.animation.add("whitty",[24,25],0,false,isPlayer);
	this.animation.add("whittyBSide",[30,31],0,false,isPlayer);
	this.animation.add("whittyBSideCrazy",[32,33],0,false,isPlayer);
	this.animation.add("whittyCrazy",[28,29],0,false,isPlayer);
	this.animation.add("wide",[26,27],0,false,isPlayer);
...
LoadingState.prototype = $extend(MusicBeatState.prototype,{
		...
		LoadingState.initSongsManifest().onComplete(function(lib) {
			...
			if(PlayState.storyWeek > 0) {
				if(PlayState.storyWeek == 7) {
					_gthis.checkLibrary("bonusWeek");
					haxe_Log.trace("loading whitty",{ fileName : "source/LoadingState.hx", lineNumber : 71, className : "LoadingState", methodName : "create"});
				} else {
	...
	,checkLibrary: function(library) {
		haxe_Log.trace(openfl_utils_Assets.hasLibrary(library),{ fileName : "source/LoadingState.hx", lineNumber : 103, className : "LoadingState", methodName : "checkLibrary"});
...
MultiCallback.prototype = {
		...
		func = function() {
			if(Object.prototype.hasOwnProperty.call(_gthis.unfired.h,id)) {
				...
				if(_gthis.logId != null) {
					if(_gthis.logId != null) {
						haxe_Log.trace("" + _gthis.logId + ": " + ("fired " + id + ", " + _gthis.numRemaining + " remaining"),{ fileName : "source/LoadingState.hx", lineNumber : 313, className : "MultiCallback", methodName : "log"});
					}
				}
				if(_gthis.numRemaining == 0) {
					if(_gthis.logId != null) {
						if(_gthis.logId != null) {
							haxe_Log.trace("" + _gthis.logId + ": " + "all callbacks fired",{ fileName : "source/LoadingState.hx", lineNumber : 313, className : "MultiCallback", methodName : "log"});
						}
					}
					_gthis.callback();
				}
			} else if(_gthis.logId != null) {
				haxe_Log.trace("" + _gthis.logId + ": " + ("already fired " + id),{ fileName : "source/LoadingState.hx", lineNumber : 313, className : "MultiCallback", methodName : "log"});
			}
		};
	...
	,log: function(msg) {
		if(this.logId != null) {
			haxe_Log.trace("" + this.logId + ": " + msg,{ fileName : "source/LoadingState.hx", lineNumber : 313, className : "MultiCallback", methodName : "log"});
		}
	}
	,getFired: function() {
